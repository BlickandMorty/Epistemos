...
struct GooseWebOnlySurfaceSourceTests {
    ...
    func nativeAgentWindowKeepsGoosePrimary() throws {
        ...
        #expect(window.contains("window.backgroundColor = bootstrap.uiState.theme.resolved.background.nsColor"))
        ...
        #expect(window.contains("host.layer?.backgroundColor = bootstrap.uiState.theme.resolved.background.nsColor.cgColor"))
        ...
        #expect(fallbackWindow.contains("window.backgroundColor = bootstrap.uiState.theme.resolved.background.nsColor"))
        ...
        #expect(fallbackWindow.contains("host.layer?.backgroundColor = bootstrap.uiState.theme.resolved.background.nsColor.cgColor"))
