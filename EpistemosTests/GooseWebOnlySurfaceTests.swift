...
struct GooseWebOnlySurfaceSourceTests {
    ...
    func nativeAgentWindowKeepsGoosePrimary() throws {
        ...
        #expect(window.contains("window.contentView?.superview?.layer?.cornerRadius = 18"))
        #expect(window.contains("window.contentView?.superview?.layer?.cornerCurve = .continuous"))
        #expect(window.contains("window.contentView?.superview?.layer?.masksToBounds = true"))
        #expect(!window.contains("WindowThemeStyler.themedContentView"))
        #expect(!window.contains("WindowThemeStyler.apply(to: window"))
        #expect(!window.contains("WindowThemeStyler.applyBackdrop"))
        ...
        #expect(fallbackWindow.contains("GooseSurfaceHostedRootView(uiState: bootstrap.uiState)"))
        #expect(fallbackWindow.contains("private func applyWindowTheme(_ window: NSWindow, theme: EpistemosTheme)"))
        #expect(fallbackWindow.contains("private struct GooseSurfaceHostedRootView: View"))
        #expect(fallbackWindow.contains("let theme = uiState.theme"))
        #expect(fallbackWindow.contains("GooseWebSurfaceView(theme: theme)"))
        #expect(fallbackWindow.contains(".onChange(of: theme)"))
        #expect(fallbackWindow.contains("onThemeChange(newTheme)"))
        ...
        #expect(fallbackWindow.contains("window.contentView?.superview?.layer?.cornerRadius = 18"))
        #expect(fallbackWindow.contains("window.contentView?.superview?.layer?.cornerCurve = .continuous"))
        #expect(fallbackWindow.contains("window.contentView?.superview?.layer?.masksToBounds = true"))
        ...
        #expect(!fallbackWindow.contains("WindowThemeStyler.applyBackdrop"))
...
"""))
        ...
        #expect(reskin.contains("--epistemos-claude-modal-scrim:"))
        #expect(reskin.contains(".replaceAll('bg-black/20', 'ep-native-modal-scrim')"))
        #expect(reskin.contains(".replaceAll('bg-black/24', 'ep-native-modal-scrim')"))
        #expect(reskin.contains(".replaceAll('text-white', 'text-text-inverse')"))
        #expect(reskin.contains(".ep-native-modal-scrim"))
        ...
        #expect(!reskin.contains("color-mix(in srgb, black"))
        #expect(!reskin.contains("color-mix(in srgb, white"))
        ...
        #expect(reskin.contains("type EpistemosWorktreeEntry"))
        #expect(reskin.contains("function epistemosWorktreeTitle(entry: EpistemosWorktreeEntry): string"))
        ...
        #expect(stageScript.contains("searchParams.get('epistemosSplitPeer')"))
        ...
        #expect(stageScript.contains("Goose Web UI main.css still contains hardcoded black/white shadow or separator colors."))
        ...
        #expect(stageScript.contains("Open GitHub pull request"))
        ...
        #expect(support.contains("--color-ring-primary: transparent !important;"))
        #expect(support.contains("--color-border-primary: transparent !important;"))
        #expect(support.contains("--epistemos-accent: \\(accent) !important;"))
        #expect(support.contains("--epistemos-quiet-focus: \\(quietFocus) !important;"))
        #expect(support.contains("--epistemos-radius-base: 11px !important;"))
        #expect(support.contains("--epistemos-radius-control: 8px !important;"))
        #expect(support.contains("--epistemos-radius-panel: 9px !important;"))
        #expect(support.contains("--tw-ring-shadow: 0 0 #0000 !important;"))
