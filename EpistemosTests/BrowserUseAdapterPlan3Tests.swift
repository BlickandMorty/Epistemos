...
struct BrowserUseAdapterPlan3Tests {
    ...
    func adapterDelegatesToBrowserUseCLIDaemon() throws {
        ...
        for required in [
            ...
            "screenshot returned too much image data",
            "screenshot PNG exceeds browser-use adapter limit",
    ...
    func rustBrowserToolsDiscoverBundledAdapterBeforePathFallback() throws {
        ...
        for required in [
            ...
            "require_packaged_bundle_signature",
            "BrowserUsePro.bundle payload root path must be Contents/Resources/BrowserUsePro",
            "BrowserUsePro.bundle code signature verification failed",
            ...
            "browser_use_packaged_adapter_requires_codesign_verification",
        ...
        for required in [
            ...
            "redacts_split_secret_assignment_key",
            "starts_with_assignment_separator_token",
            "access_token",
            "x-api-key",
            "client_secret",
            "id_token",
