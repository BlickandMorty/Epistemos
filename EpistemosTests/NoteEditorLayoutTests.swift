...
struct NoteEditorLayoutTests {
    ...
    func codeEditorDefaultsToMarkEditCoreEditorWhileKeepingLegacyFallbacks() throws {
        ...
        #expect(webKitSource.contains("MarkEditVerbatimMarkdownChromeRepresentable"))
        #expect(webKitSource.contains("makeNSViewController(context: Context) -> EditorViewController"))
        #expect(webKitSource.contains("#if canImport(MarkEditKit)"))
        ...
        #expect(html.contains("document.body.classList.toggle('plain-source', tooLarge)"))
        ...
        #expect(html.contains("color: var(--fg);"))
        #expect(html.contains("-webkit-text-fill-color: var(--fg);"))
        #expect(html.contains("background: var(--gutter);"))
    }
