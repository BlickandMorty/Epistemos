...
struct DeepResearchGateStatusTests {
    ...
    func runtimeDiagnosticsCapFFIErrorsWithoutLeakingRawLocalizedText() throws {
        ...
        #expect(DeepResearchServiceError.runtime(raw).localizedDescription.count == DeepResearchRuntimeDiagnostics.maxRuntimeErrorCharacters)
        #expect(description.contains("domain=Error"))
        #expect(description.contains("code=42"))
        ...
        #expect(bridge.contains("String(message.prefix(maxRuntimeErrorCharacters + 32))"))
        #expect(bridge.contains("String(domain.prefix(maxDomainCharacters + 32))"))
        #expect(bridge.contains("maxRuntimeErrorCharacters - 3"))
