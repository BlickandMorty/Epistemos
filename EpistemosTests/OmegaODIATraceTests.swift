...
struct ODIATraceTests {
    ...
    func generateSuccessTraces() {
        ...
        let traces = generator.generateTraces(from: [result], taskDescription: "Read a file", steps: [step])
    ...
    func filterFailures() {
        ...
        let traces = generator.generateTraces(from: [result], taskDescription: "Delete", steps: [step])
    ...
    func multipleSteps() {
        ...
        let traces = generator.generateTraces(from: [r1, r2], taskDescription: "Multi", steps: [step1, step2])
    ...
    func jsonlOutput() {
        ...
        let traces = generator.generateTraces(from: [result], taskDescription: "Test", steps: [step])
    ...
    func emptyResults() {
        let generator = ODIATraceGenerator()
        let traces = generator.generateTraces(from: [], taskDescription: "Nothing", steps: [])
