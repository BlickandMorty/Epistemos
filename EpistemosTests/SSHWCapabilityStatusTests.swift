...
struct SSHWCapabilityStatusTests {
    ...
    func advancedSeamsRemainNonLiveUntilInAppProofExists() {
        ...
        #expect(regenerate?.note.contains("explicit context metadata preservation") == true)
    ...
    func countsAndSummaryConsistent() throws {
        ...
        #expect(HTMLWorkspaceCapabilityStatus.summary.contains("explicit context metadata preservation"))
