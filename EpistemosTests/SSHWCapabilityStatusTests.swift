...
struct SSHWCapabilityStatusTests {
    ...
    func advancedSeamsRemainNonLiveUntilInAppProofExists() {
        ...
        #expect(regenerate?.note.contains("required-source availability metadata") == true)
    ...
    func countsAndSummaryConsistent() throws {
        ...
        #expect(HTMLWorkspaceCapabilityStatus.summary.contains("required-source availability metadata"))
