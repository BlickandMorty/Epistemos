...
struct SSHWCapabilityStatusTests {
    ...
    func advancedSeamsRemainNonLiveUntilInAppProofExists() {
        ...
        #expect(regenerate?.note.contains("presets") == true)
        #expect(regenerate?.note.contains("advanced manual fallback") == true)
        #expect(regenerate?.note.contains("vault-context grounding") == true)
    ...
    func countsAndSummaryConsistent() throws {
        ...
        #expect(HTMLWorkspaceCapabilityStatus.summary.contains("presets and vault-context grounding"))
