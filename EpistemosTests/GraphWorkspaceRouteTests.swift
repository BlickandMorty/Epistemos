...
struct GraphWorkspaceNotePageCompositionTests {
    ...
    func embeddedGraphNoteUsesFullNoteWorkspaceChrome() throws {
        ...
        #expect(noteWorkspace.contains("surfaceBackground: usesEmbeddedHomeGraphSurface ? noteWorkspaceBackground : nil"))
        ...
        #expect(container.contains("createUntitledHTMLWorkspaceDocument(in: preferredDirectory)"))
