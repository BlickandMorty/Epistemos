...
struct ArxivPlan3Tests {
    ...
    func arxivDisplayTextNormalizesEmbeddedControlCharacters() throws {
        ...
        #expect(ArxivSearchDiagnostics.safeDomain("NSCocoaError") == "NSCocoaError")
        #expect(ArxivSearchDiagnostics.safeDomain("NS\u{0160}CocoaError") == "Error")
        #expect(ArxivSearchDiagnostics.safeDomain("\u{FF2E}SCocoaError") == "Error")
