...
struct BrowserPlan3Tests {
    ...
    func urlGuardAllowsOnlyWebNavigation() throws {
        ...
        #expect(BrowserURLGuard.resolve(raw: "localhost:3000")?.absoluteString == "https://localhost:3000")
        #expect(BrowserURLGuard.resolve(raw: "example.com:443/path")?.absoluteString == "https://example.com:443/path")
        ...
        let colonSearch = try #require(BrowserURLGuard.resolve(raw: "plan: 3 browser"))
        #expect(colonSearch.host == "duckduckgo.com")
        #expect(colonSearch.query?.contains("plan:%203%20browser") == true)
        ...
        #expect(BrowserURLGuard.resolve(raw: "facetime:user@example.com") == nil)
        #expect(BrowserURLGuard.resolve(raw: "magnet:?xt=urn:btih:abc") == nil)
        #expect(BrowserURLGuard.resolve(raw: "https:example.com") == nil)
        #expect(BrowserURLGuard.resolve(raw: "data:8080") == nil)
    ...
    func browserSourceStaysTierOne() throws {
        ...
        #expect(source.contains("hasNonHostExplicitSchemePrefix"))
        #expect(source.contains("isLikelyHostPortInput"))
