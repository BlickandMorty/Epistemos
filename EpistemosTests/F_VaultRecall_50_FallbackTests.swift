...
struct FVaultRecall50FallbackTests {
    ...
    func vaultLookupPromptsRejectLowConfidenceSynthesisClaims() throws {
        ...
        #expect(coordinator.contains("top_hit_no_visible_evidence_reason"))
        ...
        #expect(coordinator.contains("uses_current_contract_shape=false"))
        ...
        #expect(localPrompt.contains("top_hit_no_visible_evidence_reason"))
        ...
        #expect(localPrompt.contains("uses_current_contract_shape=false"))
    ...
    func noteChatProvenanceCardsPrioritizeExactEvidenceReasons() throws {
        ...
        #expect(source.contains("appendUnique(\"Confidence\", to: &badges)"))
        #expect(source.contains("appendUnique(\"Ambiguous\", to: &badges)"))
        #expect(source.contains("appendUnique(\"Escalate\", to: &badges)"))
        #expect(source.contains("case \"Exact\": return 0"))
        #expect(source.contains("case \"Confidence\": return 1"))
        #expect(source.contains("case \"Ambiguous\": return 6"))
        ...
        #expect(source.contains("isPhraseEvidenceReason(normalized)"))
        #expect(source.contains("normalized.hasPrefix(\"phrase \")"))
        #expect(!source.contains("normalized.contains(\"phrase\")"))
        #expect(source.contains("normalized.contains(\"low top score margin\")"))
        #expect(source.contains("normalized.contains(\"ambiguous\")"))
        #expect(source.contains("normalized.contains(\"top_hit_source_rank_only\")"))
        #expect(source.contains("normalized.contains(\"top_hit_no_visible_evidence_reason\")"))
