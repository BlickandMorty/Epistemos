...
nonisolated struct HTMLWorkspaceRegeneratePatchSynthesizerTests {
    ...
    func regenerateSheetExposesTargetWorkspaceAndHashBeforeReplace() throws {
        ...
        #expect(sheet.contains("TextField(\"Search notes, folders, captures, clips, chats, graph\", text: $contextQuery)"))
    ...
    func vaultDataPresetsSeedSpecificRealContextQueries() throws {
        ...
        #expect(instruction.contains("notes, folders, captures, meeting notes, web clips, chats, or graph-related records"))
