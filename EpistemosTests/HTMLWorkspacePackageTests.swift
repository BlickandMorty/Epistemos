...
nonisolated struct HTMLWorkspacePackageTests {
    ...
    func vaultSearchDashboardTemplateSeedsLiveDataFeedShell() throws {
        ...
        #expect(package.styleCSS.contains(".pinned-context.is-drop-target"))
        ...
        #expect(package.scriptJS.contains("function pinnedContextStorageKey()"))
        #expect(package.scriptJS.contains("function loadPinnedContextKeys()"))
        #expect(package.scriptJS.contains("function savePinnedContextKeys()"))
        #expect(package.scriptJS.contains("localStorage.getItem(pinnedContextStorageKey())"))
        #expect(package.scriptJS.contains("localStorage.setItem(pinnedContextStorageKey()"))
        #expect(package.scriptJS.contains("let pinnedContextKeys = loadPinnedContextKeys();"))
        ...
        #expect(package.scriptJS.contains("didPrunePinnedContext"))
        ...
        #expect(package.scriptJS.contains("pinDroppedContextKey(key);"))
