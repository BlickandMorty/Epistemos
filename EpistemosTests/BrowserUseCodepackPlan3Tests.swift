...
struct BrowserUseCodepackPlan3Tests {
    ...
    func capabilityDocReflectsLandedBrowserUseVendorState() throws {
        ...
        #expect(codepack.contains("non-secret owner-only `PACKAGE_RESULT.json` checkpoint evidence"))
    ...
    func browserUseCodepackIsPinnedAndGated() throws {
        ...
        #expect(codepack.contains("raw status/domain/path strings bounded, control/whitespace-normalized"))
    ...
    func browserUseProPackagingScriptIsDeterministicAndProOnly() throws {
        ...
        #expect(releaseScript.contains("os.open(path, flags, 0o600)"))
        #expect(releaseScript.contains("os.fchmod(fd, 0o600)"))
