...
if [ "${EPISTEMOS_GOOSE_UI_VALIDATE_ONLY:-0}" = "1" ]; then
    ...
    grep -q "epistemos-acp-stop-bypass" "$WORK_ROOT/ui/desktop/src/acp/acpConnection.ts"
    grep -q "String(property) === 'sessionSteer_unstable'" "$WORK_ROOT/ui/desktop/src/acp/acpConnection.ts"
    grep -q "name === 'prompt' || name === 'cancel'" "$WORK_ROOT/ui/desktop/src/acp/acpConnection.ts"
    grep -q "return callACPImmediate(value, target, args, name);" "$WORK_ROOT/ui/desktop/src/acp/acpConnection.ts"
    ...
    grep -q "rounded-\\[10px\\] bg-background-primary/54 p-3" "$WORK_ROOT/ui/desktop/src/components/settings/auth/HuggingFaceSignInPrompt.tsx"
    grep -q "rounded-\\[10px\\] bg-background-primary/54 p-3" "$WORK_ROOT/ui/desktop/src/components/settings/localInference/LocalInferenceSettings.tsx"
    ...
    grep -q "bg-\\[var(--epistemos-accent)\\]/12" "$WORK_ROOT/ui/desktop/src/components/settings/localInference/LocalInferenceSettings.tsx"
    ...
    grep -q "rounded-\\[10px\\] bg-background-primary/54" "$WORK_ROOT/ui/desktop/src/components/settings/localInference/HuggingFaceModelSearch.tsx"
    ...
    grep -q "min-h-8 w-full rounded-\\[8px\\] bg-background-primary/70" "$WORK_ROOT/ui/desktop/src/components/settings/localInference/ModelSettingsPanel.tsx"
    grep -q "flex items-center justify-between gap-2 rounded-\\[9px\\] px-2 py-2" "$WORK_ROOT/ui/desktop/src/components/settings/localInference/ModelSettingsPanel.tsx"
    grep -q "min-h-32 rounded-\\[8px\\] bg-background-primary/70" "$WORK_ROOT/ui/desktop/src/components/settings/localInference/ModelSettingsPanel.tsx"
    grep -q "rounded-\\[10px\\] bg-background-danger/55" "$WORK_ROOT/ui/desktop/src/components/settings/gateways/GatewaySettingsSection.tsx"
    grep -q "rounded-\\[9px\\] bg-background-primary/54 px-2 py-1.5" "$WORK_ROOT/ui/desktop/src/components/settings/gateways/GatewaySettingsSection.tsx"
    grep -q "bg-background-primary/54" "$WORK_ROOT/ui/desktop/src/components/settings/gateways/GatewaySettingsSection.tsx"
    ...
    grep -q "bg-background-primary/92 sm:max-w-\\[400px\\]" "$WORK_ROOT/ui/desktop/src/components/settings/gateways/GatewaySettingsSection.tsx"
    grep -q "rounded-\\[9px\\] px-2 py-2 transition-colors" "$WORK_ROOT/ui/desktop/src/components/settings/dictation/DictationSettings.tsx"
    ...
    grep -q "min-h-9 items-center gap-2 rounded-\\[8px\\] bg-background-primary/70" "$WORK_ROOT/ui/desktop/src/components/settings/dictation/DictationSettings.tsx"
    grep -q "rounded-\\[9px\\] px-2 py-2 transition-colors" "$WORK_ROOT/ui/desktop/src/components/settings/dictation/MicrophoneSelector.tsx"
    ...
    grep -q "rounded-\\[10px\\] p-3 transition-colors" "$WORK_ROOT/ui/desktop/src/components/settings/dictation/LocalModelManager.tsx"
    ...
    grep -q "rounded-\\[12px\\] bg-background-secondary/62 p-4 text-left text-sm text-text-danger" "$WORK_ROOT/ui/desktop/src/components/ErrorBoundary.tsx"
    grep -q "return 'bg-background-success';" "$WORK_ROOT/ui/desktop/src/components/ToolCallStatusIndicator.tsx"
    grep -q "absolute -right-0.5 -top-0.5 h-2 w-2 rounded-full" "$WORK_ROOT/ui/desktop/src/components/ToolCallStatusIndicator.tsx"
    ! grep -q "rounded-full border border-border-primary" "$WORK_ROOT/ui/desktop/src/components/ToolCallStatusIndicator.tsx"
    ...
    grep -q "data-epistemos-recent-dir-menu-item" "$WORK_ROOT/ui/desktop/src/components/bottom_menu/DirSwitcher.tsx"
    grep -q "rounded-\\[14px\\] bg-background-primary/92" "$WORK_ROOT/ui/desktop/src/components/ParameterInputModal.tsx"
    grep -q "absolute -bottom-2 right-2 whitespace-nowrap rounded-\\[8px\\] bg-background-secondary/72" "$WORK_ROOT/ui/desktop/src/components/ChatInput.tsx"
    ...
    grep -q "rounded-\\[12px\\] bg-background-primary/54 p-3" "$WORK_ROOT/ui/desktop/src/components/onboarding/FreeOptionCards.tsx"
    grep -q "bg-\\[var(--epistemos-accent)\\]/12" "$WORK_ROOT/ui/desktop/src/components/onboarding/FreeOptionCards.tsx"
    grep -q "rounded-\\[10px\\] bg-background-danger/35 p-3" "$WORK_ROOT/ui/desktop/src/components/onboarding/FreeOptionCards.tsx"
    ! grep -q "border border-border-primary" "$WORK_ROOT/ui/desktop/src/components/onboarding/FreeOptionCards.tsx"
    ! grep -q "border border-border-danger" "$WORK_ROOT/ui/desktop/src/components/onboarding/FreeOptionCards.tsx"
    grep -q "rounded-\\[12px\\] bg-background-primary/54 p-3" "$WORK_ROOT/ui/desktop/src/components/onboarding/LocalModelPicker.tsx"
    grep -q "w-full cursor-pointer rounded-\\[10px\\] p-3 transition-colors" "$WORK_ROOT/ui/desktop/src/components/onboarding/LocalModelPicker.tsx"
    grep -q "mt-3 rounded-\\[12px\\] bg-background-secondary/44 p-3" "$WORK_ROOT/ui/desktop/src/components/onboarding/LocalModelPicker.tsx"
    ! grep -q "border border-border-primary" "$WORK_ROOT/ui/desktop/src/components/onboarding/LocalModelPicker.tsx"
    ! grep -q "border border-border-danger" "$WORK_ROOT/ui/desktop/src/components/onboarding/LocalModelPicker.tsx"
    grep -q "rounded-\\[12px\\] bg-background-primary/34 px-3 py-2" "$WORK_ROOT/ui/desktop/src/components/onboarding/ProviderSelector.tsx"
    ! grep -q "border-l border-border-primary" "$WORK_ROOT/ui/desktop/src/components/onboarding/ProviderSelector.tsx"
    grep -q "rounded-\\[12px\\] bg-background-primary/54 p-3" "$WORK_ROOT/ui/desktop/src/components/onboarding/ProviderConfigForm.tsx"
    grep -q "rounded-\\[10px\\] bg-background-danger/35 p-3 text-sm text-text-danger" "$WORK_ROOT/ui/desktop/src/components/onboarding/ProviderConfigForm.tsx"
    grep -q "bg-background-danger/35" "$WORK_ROOT/ui/desktop/src/components/ParameterInputModal.tsx"
    ...
    grep -q "bg-background-danger/35" "$WORK_ROOT/ui/desktop/src/components/ui/JsonSchemaForm.tsx"
    grep -q "isUrgent ? 'text-text-danger' : 'text-text-secondary'" "$WORK_ROOT/ui/desktop/src/components/ElicitationRequest.tsx"
    grep -q "rounded-\\[8px\\] bg-background-secondary/44 px-2 py-1.5" "$WORK_ROOT/ui/desktop/src/components/ElicitationRequest.tsx"
    ! grep -q "border-t border-border-secondary pt-3 text-xs font-sans" "$WORK_ROOT/ui/desktop/src/components/ElicitationRequest.tsx"
    grep -q "bg-\\[var(--epistemos-accent)\\]/10" "$WORK_ROOT/ui/desktop/src/components/common/InlineEditText.tsx"
    ...
    grep -q "min-w-0 break-all text-text-primary" "$WORK_ROOT/ui/desktop/src/components/SessionActionsHeader.tsx"
    grep -q "className=\"text-\\[var(--epistemos-accent)\\]\"" "$WORK_ROOT/ui/desktop/src/components/SessionActionsHeader.tsx"
    grep -q "className=\"text-text-secondary\"" "$WORK_ROOT/ui/desktop/src/components/SessionActionsHeader.tsx"
    ! grep -q -E "text-emerald|text-purple|text-amber" "$WORK_ROOT/ui/desktop/src/components/SessionActionsHeader.tsx"
    grep -q "ml-3 rounded-\\[8px\\] bg-background-secondary/40 px-3 py-1" "$WORK_ROOT/ui/desktop/src/components/SessionActionsHeader.tsx"
    grep -q "rounded-\\[10px\\] bg-background-primary/60 p-3" "$WORK_ROOT/ui/desktop/src/components/SessionActionsHeader.tsx"
    grep -q "min-h-0 overflow-hidden rounded-\\[12px\\] bg-background-secondary/54" "$WORK_ROOT/ui/desktop/src/components/SessionActionsHeader.tsx"
    grep -q "rounded-\\[12px\\] bg-background-secondary/54 p-4" "$WORK_ROOT/ui/desktop/src/components/SessionActionsHeader.tsx"
    ...
    grep -q "rounded-\\[12px\\] bg-background-danger/55 p-4 text-text-danger" "$WORK_ROOT/ui/desktop/src/components/McpApps/McpAppRenderer.tsx"
    grep -q "isError && 'rounded-\\[12px\\] bg-background-danger/35'" "$WORK_ROOT/ui/desktop/src/components/McpApps/McpAppRenderer.tsx"
    ...
    grep -q "my-2 rounded-\\[12px\\] bg-background-warning/55 p-4" "$WORK_ROOT/ui/desktop/src/components/context_management/CreditsExhaustedNotification.tsx"
    grep -q "ep-native-loading-dot is-active" "$WORK_ROOT/ui/desktop/src/components/MessageQueue.tsx"
    grep -q "rounded-\\[12px\\] bg-background-primary/42 px-4 py-2.5" "$WORK_ROOT/ui/desktop/src/components/MessageQueue.tsx"
    grep -q "rounded-\\[8px\\] bg-background-secondary/60 px-2 py-1" "$WORK_ROOT/ui/desktop/src/components/MessageQueue.tsx"
    grep -q "rounded-\\[10px\\] bg-background-warning/35 px-4 py-1.5" "$WORK_ROOT/ui/desktop/src/components/MessageQueue.tsx"
    grep -q "rounded-\\[10px\\] px-3 py-2 transition-colors" "$WORK_ROOT/ui/desktop/src/components/MessageQueue.tsx"
    grep -q "bg-background-primary/54 hover:bg-background-secondary/56" "$WORK_ROOT/ui/desktop/src/components/MessageQueue.tsx"
    grep -q "bg-background-secondary/60 text-text-muted" "$WORK_ROOT/ui/desktop/src/components/MessageQueue.tsx"
    grep -q "rounded-\\[8px\\] bg-background-primary/60 px-2 py-1 text-sm" "$WORK_ROOT/ui/desktop/src/components/MessageQueue.tsx"
    ! grep -q "border border-border-primary" "$WORK_ROOT/ui/desktop/src/components/MessageQueue.tsx"
    ! grep -q "border-b border-border" "$WORK_ROOT/ui/desktop/src/components/MessageQueue.tsx"
    ...
    grep -q "bg-background-danger/35" "$WORK_ROOT/ui/desktop/src/components/settings/providers/modal/subcomponents/forms/CustomProviderForm.tsx"
    ...
    grep -q "bg-background-primary/24" "$WORK_ROOT/ui/desktop/src/components/ToolCallWithResponse.tsx"
    ! grep -q "border-t border-border-primary" "$WORK_ROOT/ui/desktop/src/components/ToolCallWithResponse.tsx"
    grep -q "goose-message-content overflow-hidden rounded-\\[12px\\] bg-background-primary/54" "$WORK_ROOT/ui/desktop/src/components/ToolCallConfirmation.tsx"
    grep -q "bg-background-secondary/62 px-3 py-2 text-xs font-sans" "$WORK_ROOT/ui/desktop/src/components/ToolCallConfirmation.tsx"
    grep -q "mb-2 text-sm italic text-text-secondary" "$WORK_ROOT/ui/desktop/src/components/sessions/SessionViewComponents.tsx"
    grep -q "goose-message-tool mt-1 rounded-\\[12px\\] bg-background-primary/54" "$WORK_ROOT/ui/desktop/src/components/sessions/SessionViewComponents.tsx"
    grep -q "mx-auto my-2 w-full max-w-4xl rounded-\\[12px\\] bg-background-secondary/56" "$WORK_ROOT/ui/desktop/src/components/UserMessage.tsx"
    grep -q "w-full resize-none rounded-\\[10px\\] bg-background-primary/60 text-sm leading-relaxed" "$WORK_ROOT/ui/desktop/src/components/UserMessage.tsx"
    ! grep -q "border border-border-primary" "$WORK_ROOT/ui/desktop/src/components/UserMessage.tsx"
    grep -q "mb-4 max-w-md rounded-\\[12px\\] bg-background-danger/35 p-4" "$WORK_ROOT/ui/desktop/src/components/BaseChat.tsx"
    grep -q "rounded-\\[8px\\] bg-background-secondary/56 px-4 py-2" "$WORK_ROOT/ui/desktop/src/components/BaseChat.tsx"
    grep -q "no-drag flex items-center gap-2 rounded-\\[8px\\] bg-background-primary/58" "$WORK_ROOT/ui/desktop/src/components/BaseChat.tsx"
    ! grep -q "border border-border-primary" "$WORK_ROOT/ui/desktop/src/components/BaseChat.tsx"
    ...
    grep -q "min-h-8 rounded-\\[8px\\] bg-background-primary/70" "$WORK_ROOT/ui/desktop/src/components/schedule/CronPicker.tsx"
    ...
    grep -q "flex shrink-0 items-center bg-background-primary/70 px-3" "$WORK_ROOT/ui/desktop/src/components/McpApps/McpAppRenderer.tsx"
    ...
    grep -q "accent-\\[var(--epistemos-accent)\\]" "$WORK_ROOT/ui/desktop/src/components/recipes/shared/SubRecipeModal.tsx"
    ! grep -q "border-b border-borderSubtle" "$WORK_ROOT/ui/desktop/src/components/recipes/shared/SubRecipeModal.tsx"
    ! grep -q "border border-border-subtle" "$WORK_ROOT/ui/desktop/src/components/recipes/shared/SubRecipeModal.tsx"
    ...
    grep -q "flex items-center justify-between bg-background-primary/42 p-6" "$WORK_ROOT/ui/desktop/src/components/recipes/shared/CreateSubRecipeInline.tsx"
    grep -q "w-full rounded-\\[10px\\] bg-background-primary/60 p-3 text-text-standard" "$WORK_ROOT/ui/desktop/src/components/recipes/shared/CreateSubRecipeInline.tsx"
    grep -q "flex justify-end gap-3 bg-background-primary/42 p-6" "$WORK_ROOT/ui/desktop/src/components/recipes/shared/CreateSubRecipeInline.tsx"
    ...
    grep -q "epistemos-native-claude-desktop-lock" "$WORK_ROOT/ui/desktop/src/styles/main.css"
...
JS
    ...
    grep -q "rounded-\\[9px\\] p-1 space-y-0.5" "$WORK_ROOT/ui/desktop/src/components/ui/dropdown-menu.tsx"
    ...
    grep -q "mb-2 flex items-baseline gap-1 font-sans text-text-secondary" "$WORK_ROOT/ui/desktop/src/components/Hub.tsx"
    grep -q "text-\\[13px\\] font-medium text-text-secondary tabular-nums" "$WORK_ROOT/ui/desktop/src/components/Hub.tsx"
    grep -q "mb-4 text-sm font-medium text-text-primary tracking-normal" "$WORK_ROOT/ui/desktop/src/components/Hub.tsx"
    ! grep -q "ep-display text-4xl" "$WORK_ROOT/ui/desktop/src/components/Hub.tsx"
    ...
    grep -q "flex h-full flex-col bg-background-secondary/72 outline-none" "$WORK_ROOT/ui/desktop/src/components/Layout/NavigationPanel.tsx"
    grep -q "flex flex-col gap-1 px-2 pt-2" "$WORK_ROOT/ui/desktop/src/components/Layout/NavigationPanel.tsx"
    ...
    grep -q "px-2 pb-2 pt-2 bg-transparent" "$WORK_ROOT/ui/desktop/src/components/Layout/NavigationPanel.tsx"
    grep -q "px-3 py-2 text-\\[13px\\] text-text-secondary" "$WORK_ROOT/ui/desktop/src/components/Layout/NavigationPanel.tsx"
    ...
    grep -q "fixed z-50 max-h-80 min-w-96 max-w-lg overflow-hidden rounded-\\[14px\\] bg-background-primary/92" "$WORK_ROOT/ui/desktop/src/components/MentionPopover.tsx"
    ...
    grep -q "bg-background-primary/58 px-6 pb-5 pt-14" "$WORK_ROOT/ui/desktop/src/components/sessions/SessionListView.tsx"
    ...
    grep -q "ep-native-header-band flex flex-col rounded-\\[16px\\] bg-background-primary/42 p-4" "$WORK_ROOT/ui/desktop/src/components/sessions/SharedSessionView.tsx"
    grep -q "ep-native-header-band flex flex-col rounded-\\[16px\\] bg-background-primary/42 p-4 pt-5" "$WORK_ROOT/ui/desktop/src/components/sessions/SessionHistoryView.tsx"
    ...
    grep -q "bg-background-danger/35 text-text-danger" "$WORK_ROOT/ui/desktop/src/components/schedule/ScheduleDetailView.tsx"
    grep -q "ep-native-list-card cursor-pointer p-4" "$WORK_ROOT/ui/desktop/src/components/schedule/ScheduleDetailView.tsx"
    ...
    grep -q "rounded-\\[10px\\] bg-background-secondary/56" "$WORK_ROOT/ui/desktop/src/components/schedule/ScheduleModal.tsx"
    ...
    grep -q "ep-native-screen-card w-\\[500px\\] max-w-\\[90vw\\] p-6" "$WORK_ROOT/ui/desktop/src/components/recipes/ImportRecipeForm.tsx"
    grep -q "ep-native-screen-card flex max-h-\\[80vh\\] w-\\[800px\\]" "$WORK_ROOT/ui/desktop/src/components/recipes/ImportRecipeForm.tsx"
    grep -q "bg-background-danger/35" "$WORK_ROOT/ui/desktop/src/components/recipes/ImportRecipeForm.tsx"
    ...
    grep -q "bg-background-danger/35" "$WORK_ROOT/ui/desktop/src/components/recipes/shared/InstructionsEditor.tsx"
    grep -q "bg-background-danger/35" "$WORK_ROOT/ui/desktop/src/components/recipes/shared/JsonSchemaEditor.tsx"
    grep -q "w-full resize-none rounded-\\[10px\\] bg-background-primary/60 p-3" "$WORK_ROOT/ui/desktop/src/components/recipes/shared/RecipeFormFields.tsx"
    grep -q "rounded-\\[12px\\] bg-background-secondary/56 px-4 py-3" "$WORK_ROOT/ui/desktop/src/components/recipes/shared/RecipeFormFields.tsx"
    grep -q "rounded-\\[12px\\] bg-background-secondary/32 px-4 py-3" "$WORK_ROOT/ui/desktop/src/components/recipes/shared/RecipeFormFields.tsx"
    grep -q "flex-1 rounded-\\[10px\\] bg-background-primary/60 px-3 py-2 text-sm" "$WORK_ROOT/ui/desktop/src/components/recipes/shared/RecipeFormFields.tsx"
    ! grep -q "border-l-2 border-border-primary" "$WORK_ROOT/ui/desktop/src/components/recipes/shared/RecipeFormFields.tsx"
    grep -q "space-y-2 rounded-\\[12px\\] bg-background-secondary/44 p-3" "$WORK_ROOT/ui/desktop/src/components/recipes/shared/KeyValueEditor.tsx"
    ! grep -q "border border-border-subtle" "$WORK_ROOT/ui/desktop/src/components/recipes/shared/KeyValueEditor.tsx"
    ...
    grep -q "rounded-\\[12px\\] bg-background-primary/54 p-4" "$WORK_ROOT/ui/desktop/src/components/recipes/shared/SubRecipeEditor.tsx"
    grep -q "rounded-\\[12px\\] bg-background-danger/55" "$WORK_ROOT/ui/desktop/src/components/recipes/shared/RecipeModelSelector.tsx"
    grep -q "rounded-\\[12px\\] bg-background-warning/55" "$WORK_ROOT/ui/desktop/src/components/ui/RecipeWarningModal.tsx"
    ...
    grep -q "rounded-\\[14px\\] bg-background-secondary/70" "$WORK_ROOT/ui/desktop/src/components/settings/providers/modal/subcomponents/ProviderLogo.tsx"
    grep -q "h-11 w-full rounded-\\[8px\\] bg-background-primary/55" "$WORK_ROOT/ui/desktop/src/components/settings/providers/modal/subcomponents/ProviderSetupActions.tsx"
    ...
    grep -q "rounded-\\[10px\\] bg-background-primary/55" "$WORK_ROOT/ui/desktop/src/components/settings/providers/modal/subcomponents/forms/DefaultProviderSetupForm.tsx"
    grep -q "rounded-\\[10px\\] bg-background-primary/54 p-4" "$WORK_ROOT/ui/desktop/src/components/settings/providers/modal/subcomponents/forms/CustomProviderForm.tsx"
    grep -q "rounded-\\[10px\\] bg-background-warning/55" "$WORK_ROOT/ui/desktop/src/components/settings/providers/modal/subcomponents/forms/CustomProviderForm.tsx"
    grep -q "rounded-\\[10px\\] bg-background-danger/55" "$WORK_ROOT/ui/desktop/src/components/settings/providers/modal/subcomponents/forms/CustomProviderForm.tsx"
    ...
    grep -q "rounded-\\[10px\\] bg-background-primary/54 p-4" "$WORK_ROOT/ui/desktop/src/components/settings/providers/modal/subcomponents/ProviderCatalogPicker.tsx"
    ...
    grep -q "rounded-\\[12px\\] bg-background-secondary/62" "$WORK_ROOT/ui/desktop/src/components/settings/extensions/modal/ExtensionModal.tsx"
    grep -q "rounded-\\[8px\\] bg-background-primary/70" "$WORK_ROOT/ui/desktop/src/components/settings/extensions/modal/EnvVarsSection.tsx"
    grep -q "rounded-\\[8px\\] bg-background-primary/70" "$WORK_ROOT/ui/desktop/src/components/settings/extensions/modal/HeadersSection.tsx"
    ...
    grep -q "bg-background-danger/35" "$WORK_ROOT/ui/desktop/src/components/settings/extensions/modal/ExtensionTimeoutField.tsx"
    ...
    grep -q "min-h-\\[128px\\] overflow-hidden bg-background-primary/54" "$WORK_ROOT/ui/desktop/src/components/settings/extensions/subcomponents/ExtensionItem.tsx"
    ...
    grep -q "peer-checked:bg-\\[var(--epistemos-accent)\\]" "$WORK_ROOT/ui/desktop/src/components/settings/mode/ModeSelectionItem.tsx"
    ...
    grep -q "peer-checked:bg-\\[var(--epistemos-accent)\\]" "$WORK_ROOT/ui/desktop/src/components/settings/response_styles/ResponseStyleSelectionItem.tsx"
    ! grep -q "peer-checked:border-\\[var(--epistemos-accent)\\]" "$WORK_ROOT/ui/desktop/src/components/settings/response_styles/ResponseStyleSelectionItem.tsx"
    ...
    grep -q "rounded-\\[11px\\] bg-background-primary/54" "$WORK_ROOT/ui/desktop/src/components/settings/permission/PermissionRulesModal.tsx"
    grep -q "rounded-\\[14px\\] bg-background-secondary/62" "$WORK_ROOT/ui/desktop/src/components/settings/permission/PermissionRulesModal.tsx"
    ...
    grep -q "bg-background-warning/55" "$WORK_ROOT/ui/desktop/src/components/settings/PromptsSettingsSection.tsx"
    grep -q "bg-background-primary/42 p-3 pb-4" "$WORK_ROOT/ui/desktop/src/components/settings/models/ModelsSection.tsx"
    grep -q "bg-background-primary/42 pb-2" "$WORK_ROOT/ui/desktop/src/components/settings/models/ModelsSection.tsx"
    grep -q "rounded-\\[10px\\] bg-background-danger/28 p-3" "$WORK_ROOT/ui/desktop/src/components/settings/reset_provider/ResetProviderSection.tsx"
    grep -q "bg-background-primary/34 px-2" "$WORK_ROOT/ui/desktop/src/components/settings/models/bottom_bar/ModelsBottomBar.tsx"
    grep -q "rounded-\\[14px\\] bg-background-primary/92" "$WORK_ROOT/ui/desktop/src/components/settings/models/bottom_bar/ModelsBottomBar.tsx"
    ...
    grep -q "rounded-\\[10px\\] px-3 py-2.5 text-text-primary" "$WORK_ROOT/ui/desktop/src/components/settings/models/subcomponents/SwitchModelModal.tsx"
    grep -q "peer-checked:bg-\\[var(--epistemos-accent)\\]" "$WORK_ROOT/ui/desktop/src/components/settings/models/subcomponents/SwitchModelModal.tsx"
    ...
    grep -q "rounded-\\[9px\\] px-3 py-2.5 transition-colors" "$WORK_ROOT/ui/desktop/src/components/settings/keyboard/KeyboardShortcutsSection.tsx"
    ...
    grep -q "select__menu z-\\[9999\\] absolute overflow-hidden" "$WORK_ROOT/ui/desktop/src/components/ui/Select.tsx"
