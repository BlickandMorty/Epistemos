...
| 9 | [`experimental-realistic-input-verification`](experimental-realistic-input-verification/SKILL.md) | TEMPER methodology: verify substrate-matching code with the input SHAPES that actually occur (NL prompts, ordinal/slug filenames, H1≠filename, wikilink variants) — keyword fixtures give false green. Add BOTH positive + guard to the witness. **Found 4 silent bugs in 4 cycles.** | the NL-grounding / ordinal-filename / H1-title / grounding-title fixes |
