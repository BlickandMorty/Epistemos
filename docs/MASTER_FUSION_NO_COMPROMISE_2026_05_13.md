...
| **Provenance Console** | `EPISTEMOS_FINAL_DOCTRINE` §4, audit reconciliation; T2 `faf76214a`; T6 `fec5c4773`; T6 `a36355d51` | MATCHES / BRANCH PATCH — shipped console plus branch projection of run-completed AnswerPacket metadata; branch UI adds manual refresh and load-more pagination | `Epistemos/Views/Provenance/`, `ProvenanceConsoleProjectionService.swift`, `Epistemos/Views/Settings/ProvenanceConsoleView.swift` |
