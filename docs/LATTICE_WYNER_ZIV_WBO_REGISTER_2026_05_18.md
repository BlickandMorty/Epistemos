...
| `SherryTernary3Of4` | L1 Compressed Residual; Sherry codec row | `F-WBO-DriftLedger`; `F-ULP-Oracle`; residual KL slice of `F-KV-Direct-Gate` when transferred to residuals |
