...
- Metal documentation: MTLBuffer, MTLStorageMode, MTLCaptureManager ^1^ ^2^ ^3^ ^4^ ^5^- MLX issues: no in-place ops, custom kernel read+write ^6^- Metal Frame Capture programmatic API ^7^ ^8^ ^9^ ^10^- Metal Performance Optimization (WWDC 2015) ^11^- Apple Silicon UMA architecture ^12^ ^13^- KV cache internals and prefill/decode mechanics ^14^ ^15^ ^16^ ^17^*
