...
- 25+ requests per second on consumer hardware [^1^]

**This enables local agent swarms.** 5-10 specialized agents running concurrently on one Mac, each handling different aspects of a task.
