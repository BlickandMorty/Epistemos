...
- Anthropic "Scaling Monosemanticity" paper (May 2024) [^2344^][^2354^]
- OpenAI SAE research (June 2024) [^2344^]
- Google DeepMind Gemma Scope (July 2024) [^2344^][^2348^]
- SAE survey paper (EMNLP 2025) [^2344^]
- Anthropic feature steering documentation [^2363^][^2365^]
- Neuronpedia steering API [^2365^]
- macmon/FluidTop ANE power monitoring tools [^2352^][^2353^]
- M4 ANE direct programming research (maderix 2026) [^374^]
- MLX Metal debugger documentation [^2347^]
- Core ML custom layer protocols [^2356^][^2360^]
- Mechanistic interpretability community research (SAELens, etc.) [^2345^][^2346^]*
