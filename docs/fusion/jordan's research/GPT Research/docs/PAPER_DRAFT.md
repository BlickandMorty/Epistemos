...
A research-paper skeleton for the residual-first six-tier memory substrate, WBO-6 bound accounting, deterministic replay, and Mac-native MLX/Metal implementation.
