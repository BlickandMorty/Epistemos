...
Single binary, one substrate, three envelopes, zero forks. The substrate owns memory, provenance, gates, and deterministic replay. Hermes is an execution boundary, not an authority.
