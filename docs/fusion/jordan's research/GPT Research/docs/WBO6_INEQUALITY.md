...
The measured logit drift bound is half the sum of T_W, T_K, T_R, T_Q, T_S, and T_SE. This scaffold implements the accounting surface and asserts measured KL stays below the bound.
