...
The scaffold treats KV-Direct as the first falsifier, then compares ShadowKV/KVSwap/DeltaKV-style cache policies against residual-first L1 plus L2 routing.
