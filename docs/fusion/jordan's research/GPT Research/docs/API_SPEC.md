...
The API exposes Helios core math, tensor golden references, quantization codecs, runtime agents, Hermes grants, model harnesses, benchmarks, and UniFFI vault operations.
