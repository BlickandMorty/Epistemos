...
All public Rust items should be documented, unsafe is forbidden in the portable core, platform features require explicit gates, and performance claims need benchmark artifacts.
