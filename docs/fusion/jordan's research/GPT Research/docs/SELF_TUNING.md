...
L_SE uses surprise-gradient routing: sketch for weak signals, fast weights for session signals, LoRA for repeated strong signals, and offline consolidation for durable adapters.
