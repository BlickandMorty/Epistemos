# Six-Tier Memory Specification

## Purpose

L0 exact hot, L1 residual checkpoint with deterministic K/V recomputation, L2 sparse JL plus CountSketch routing, L3 mmap SSD oracle, L4 Hermes cascade, L_SE bounded self-evolving memory.
