...
MAS Core denies shell/process automation, uses App Sandbox, security-scoped bookmarks, biometric gates, App Group-scoped shared state, and XPC-isolated cloud boundary.
