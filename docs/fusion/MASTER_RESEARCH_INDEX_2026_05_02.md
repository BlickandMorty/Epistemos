...
| `F-DepthLease-Checkpoint` | Current active cursor. Proves dynamic-depth choices declare shallow exit, deeper wake, verifier margin, maximum extra layers, and full-depth fallback. |
