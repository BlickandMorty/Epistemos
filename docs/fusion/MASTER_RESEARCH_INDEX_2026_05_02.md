...
| `F-ProofSearchSignal-RouteFeedback` | Current active cursor. Proves Lean/proof outcomes become route features without becoming hidden truth or bypassing AnswerPacket. |
