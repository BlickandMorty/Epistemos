...
| `F-ProofPressureSignal` | Current active cursor. Proves compiler errors, missing premises, tactic-state entropy, and failed attempt memory become explicit route-pressure labels. |
