...
| `F-VerifierBudgetAuction` | Current active cursor. Proves candidate units compete under verifier, byte, and latency budgets and over-budget bundles are rejected before execution. |
