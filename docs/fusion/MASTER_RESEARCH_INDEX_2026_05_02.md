...
| `F-KVPageBloomSketch-Coverage` | Current active cursor. Proves cheap page filters do not drop required proof/citation evidence under the declared coverage target. |
