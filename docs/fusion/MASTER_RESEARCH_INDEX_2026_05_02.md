...
| `F-VerifierRegretFastWeights` | Current active cursor. Proves fast-weight updates are bounded, local, resettable, TTL-limited, shadow-only, rollback-bound, and useful on held-out route choices. |
