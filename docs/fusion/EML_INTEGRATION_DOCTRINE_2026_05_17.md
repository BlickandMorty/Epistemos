...
### (c) KuramotoSync / ResonanceSync tempering — COORD T3

**Host**: legacy path `agent_core/src/research/acs/kuramoto.rs` (T3's
UAS/AcsAnchor slice; explicitly out of T7 scope per the worktree's DON'T
TOUCH list). Current prose calls this KuramotoSync / ResonanceSync, not
the legacy ACS/Kuramoto phrase.
