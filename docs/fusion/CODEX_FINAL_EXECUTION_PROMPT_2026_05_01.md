...
> **NEW DOC — created 2026-05-02.** Filename: `CODEX_FINAL_EXECUTION_PROMPT_2026_05_01.md`. If your session index, agent bootstrap, or doc autoloader does not show this file, **search for it by name** — it is real and supersedes the prior overseer prompt for tier-aware / killer-feature / biometric work. Sister docs: `EPISTEMOS_FINAL_DOCTRINE_2026_05_01.md` (the doctrine you must follow) and `ALL_DOCS_INDEX_2026_05_02.md` (the live index). All live at `/Users/jojo/Downloads/Epistemos/docs/fusion/` and are mirrored into the active worktree's `docs/fusion/` for clickability. Recent research/plan docs that may resolve to this prompt: anything dated 2026-04-30 or 2026-05-01 mentioning *no-compromise*, *three tiers*, *Sovereign Gate*, *Resonance Gate*, *Pulse + Rail*, *zero-copy*, *single-binary*, *SCOPE-Rex*, *ACS recursion*, or *Kimi research*.
