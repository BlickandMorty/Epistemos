...
| `F-VerifierRegretFastWeights` | Current active cursor. Must prove verifier-regret fast weights are bounded, session/local scoped, resettable, TTL-limited, shadow-only, rollback-bound, AnswerPacket-visible, and held-out useful before any consolidation or live policy influence. |
