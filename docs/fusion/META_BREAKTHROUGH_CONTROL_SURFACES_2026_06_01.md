...
| `F-SparseRoute-NoHiddenAuthority` | Current active cursor. Must prove sparse route control cannot treat source priors, proof traces, oracle labels, or formal-math motifs as hidden live authority before route-source claims promote. |
