...
| `F-ShadowWakeOracle` | Current active cursor. Must prove full-wake/proof/test oracle traces create route labels without becoming a hidden live runtime dependency. |
