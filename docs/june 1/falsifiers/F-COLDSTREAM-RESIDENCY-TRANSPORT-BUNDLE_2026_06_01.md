...
status: backlog gates; no live cold transport promotion without platform-gated benchmarks
---
...
Current cursor after the 2026-06-04 `F-ColdStream-NoHiddenAuthority` metadata-only witness: `provider_route_copy_source_guard`.
