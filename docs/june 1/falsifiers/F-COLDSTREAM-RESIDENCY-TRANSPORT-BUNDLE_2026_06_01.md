...
Current cursor after the 2026-06-05 `F-SmallModelRuntimeHarnessFreshProductRuntimeL3ManualRuntimeVerificationProbe`: `small_model_runtime_harness_fresh_product_runtime_l3_capability_closeout_probe`.
