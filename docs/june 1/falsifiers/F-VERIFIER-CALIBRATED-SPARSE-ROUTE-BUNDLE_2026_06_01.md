...
| `F-VerifierRegretFastWeights` | Current active cursor: fast-weight updates are bounded, session/local scoped, resettable, TTL-limited, and improve held-out route choice before consolidation. | Drift-bound test plus reset and held-out regression. |
