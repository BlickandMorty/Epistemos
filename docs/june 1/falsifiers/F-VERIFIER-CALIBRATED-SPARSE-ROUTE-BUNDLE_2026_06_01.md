...
| `F-LayerKVJointLease` | Current active cursor: dynamic depth and KV/page selection are decided together, with expected attention error, verifier margin, and full-depth fallback. | Joint lease fixture plus shallow-wrong-page negative. |
