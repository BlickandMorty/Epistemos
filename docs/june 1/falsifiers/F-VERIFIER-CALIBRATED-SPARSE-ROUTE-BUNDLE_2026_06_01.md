...
| `F-ShadowWakeOracle` | Current active cursor: full-wake/proof/test oracle traces create route labels without becoming a live runtime dependency. | Oracle-label fixture plus no-runtime-dependency static check. |
