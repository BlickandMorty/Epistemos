...
| `F-ProofPressureSignal` | Current active cursor: compiler errors, tactic-state entropy, missing premises, and failed attempt memory produce explicit route-pressure labels. | Proof-pressure fixture plus statement-preservation and missing-premise cases. |
