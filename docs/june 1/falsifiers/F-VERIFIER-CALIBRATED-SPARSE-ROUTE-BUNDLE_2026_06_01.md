...
| `F-DepthLease-Checkpoint` | Current active cursor: dynamic-depth decisions declare shallow exit, deeper wake, verifier margin, maximum extra layers, and full-depth fallback. | Depth-lease fixture plus invalid silent-depth negative. |
