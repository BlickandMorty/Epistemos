...
| `F-KVPageSketchIndex` | Current active cursor: KV/page sketches bind UAS address, byte count, compatibility fence, min/max or semantic sketches, hits, misses, and privacy class. | Sketch-index fixture plus stale/incompatible rejection. |
