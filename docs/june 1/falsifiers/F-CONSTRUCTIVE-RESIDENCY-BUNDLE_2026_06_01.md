...
- Current cursor after the 2026-06-04 `F-SlabArena-CopyCount` metadata-only witness: `metal_io_feature_gate`. This remains L1-only; L2 product capability and L3 user-facing runtime are unchanged.
