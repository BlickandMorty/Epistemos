...
- Current cursor after the 2026-06-05 `F-TransportCancellation` metadata-only witness: `cache_policy_pollution`. This remains L1-only; L2 product capability and L3 user-facing runtime are unchanged.
