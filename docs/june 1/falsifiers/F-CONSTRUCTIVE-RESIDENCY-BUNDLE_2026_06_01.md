...
- Current cursor after the 2026-06-05 `F-SmallModelRuntimeHarnessFreshProductRuntimeL3ManualRuntimeVerificationProbe`: `small_model_runtime_harness_fresh_product_runtime_l3_capability_closeout_probe`. This advances L1 blocker-ledger proof only; L2 product capability remains `vault_research_route_with_packetized_mitigation`, and broader fresh app runtime capability remains unchanged until L3 log-correlated runtime proof passes.
