...
- Current cursor after the 2026-06-05 `F-CodecStage-Latency` metadata-only witness: `transport_cancellation`. This remains L1-only; L2 product capability and L3 user-facing runtime are unchanged.
