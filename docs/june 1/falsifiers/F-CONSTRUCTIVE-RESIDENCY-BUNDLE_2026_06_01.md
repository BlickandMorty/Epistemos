...
- Current cursor after the 2026-06-05 `F-CachePolicy-Pollution` metadata-only witness: `cold_panic_fallback`. This remains L1-only; L2 product capability and L3 user-facing runtime are unchanged.
