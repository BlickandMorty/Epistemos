...
- Current cursor after the 2026-06-04 `F-MetalIO-FeatureGate` metadata-only witness: `codec_stage_latency`. This remains L1-only; L2 product capability and L3 user-facing runtime are unchanged.
