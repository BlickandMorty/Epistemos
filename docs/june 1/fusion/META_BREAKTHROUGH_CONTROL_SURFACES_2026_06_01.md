...
| `F-ProofSearchSignal-RouteFeedback` | Current active cursor. Proves Lean/proof outcomes become route features without hidden truth, verifier bypass, or AnswerPacket omission. |
