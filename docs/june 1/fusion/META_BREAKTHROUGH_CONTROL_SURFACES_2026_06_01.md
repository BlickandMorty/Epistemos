...
| `F-SparseWakeCertificate-AnswerPacket` | Current active cursor. Proves selected sparse/KV units, budgets, verifier/citation/test results, traces, uncertainty, fallback, and rollback are visible in an AnswerPacket-bound certificate before live route authority can promote. |
