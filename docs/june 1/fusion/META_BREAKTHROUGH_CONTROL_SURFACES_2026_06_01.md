...
| `F-AxiomAxiomatic-SourceDistinction` | Current active cursor. Must keep Axiom, Axiomatic AI, OProver, Harmonic, UlamAI, Math Inc, and OpenGauss motifs source-distinct before route-source claims promote. |
