...
| `F-AblationShadowRun` | Current active cursor. Must prove claimed useful units survive counterfactual remove-one-unit comparison without hidden live route authority. |
