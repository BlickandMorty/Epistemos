...
| `F-QueryAwareKVSelector` | Current active cursor. Proves query-aware KV/page selection beats random, recency-only, and file-order baselines before live route authority can promote. |
