...
| `F-KVPageBloomSketch-Coverage` | Current active cursor. Proves bloom-like KV/page filters may over-include but cannot drop required proof or privacy evidence before query-aware page selection can promote. |
