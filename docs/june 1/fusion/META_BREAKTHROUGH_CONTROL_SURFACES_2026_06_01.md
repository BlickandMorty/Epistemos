...
| `F-KVPageSketchIndex` | Current active cursor. Proves KV/page sketches bind UAS address, byte count, compatibility fence, sketch evidence, hits, misses, and privacy class before query-aware page selection can promote. |
