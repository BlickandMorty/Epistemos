...
| `F-KVPageSketchIndex` | Current active cursor. Proves page sketches bind UAS address, byte count, compatibility fence, sketches/tags, hits, misses, and privacy class. |
