...
| `F-QueryAwareKVSelector` | Current active cursor. Proves query-aware page selection beats random, recency-only, and file-order baselines on held-out long-context fixtures. |
