...
| `F-ConstructionSearchTournament` | Current active cursor. Proves PatternBoost/Axplorer-style generate-repair-score-select improves sparse wake plans over random generation under fixed budget. |
