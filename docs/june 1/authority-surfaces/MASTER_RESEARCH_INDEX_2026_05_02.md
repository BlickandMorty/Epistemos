...
| `F-FastWeightQuarantine` | Current active cursor. Proves fast-weight deltas remain shadow-only until drift, held-out, rollback, TTL, reset, RunEventLog, and AnswerPacket gates pass. |
