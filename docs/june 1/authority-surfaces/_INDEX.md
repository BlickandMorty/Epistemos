...
>
> **2026-06-01 supersession:** full-thread codeword
> `JUNE1-CANON-FUSION-LOCK`. This legacy index now defers current
> local-inference, formal math, UAS/AppColdStore, active model-state, sparse
> residency, cache lineage, portable note/editor systems, engineering logic,
> semantic working sets, substrate trace observability, verifier sparse routing,
> ColdStream, mmap/SSD hot paths, dynamic compute, route-layout, and
> 70B-cocktail doctrine to `docs/EPISTEMOS_LIVING_INDEX_2026_05_24.md`,
> `docs/fusion/MASTER_RESEARCH_INDEX_2026_05_02.md`, and
> `docs/audits/CODEX_JUNE1_FULL_THREAD_CANON_REINTEGRATION_PROMPT_2026_06_01.md`.
> The narrow residency subset is `JUNE1-PATTERNBOOST-LOCK`, anchored by
> `docs/fusion/RESIDENCY_PATTERNBOOST_DISCOVERY_2026_06_01.md` and
> `docs/falsifiers/F-RESIDENCY-PATTERNBOOST-BUNDLE_2026_06_01.md`. Older rows
> remain provenance unless the living index or master research index promotes
> them forward.
