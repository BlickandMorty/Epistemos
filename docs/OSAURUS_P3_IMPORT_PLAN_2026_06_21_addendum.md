...
> 🔴 **SUPERSEDED-IN-FRAME 2026-07-02.** Osaurus/three-engine was already CUT (goose-only lock 2026-06-28); now further re-scoped: current surfaces are Experimental/1Code + MAS/June; OpenChamber/ProAgent are deletion targets. No Osaurus/Act/three-engine revival. Mine only for any durable model-catalog UX ideas. Canon: memory `project_ui_base_pivot_openchamber_2026_07_02`.
