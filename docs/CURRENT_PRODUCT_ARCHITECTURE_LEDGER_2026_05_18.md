...
| **Lane** | `R0` |
| **Ledger statistics (auto-verified iter-65)** | 1020+ lines; 56+ subsystem rows; 58+ falsifier fields. 2 meta-pattern rows (§20 god-state, §21 dual-API). 1 W-row appended to backlog (W-46 macaroons-orphan doc drift). |
...
| **Falsifier count gaps** | Falsifiers per row average ≈ 1.04. Some rows name 0 explicit falsifier in the "Falsifier" field (e.g. §14 lists section). Rows that cross-link to existing falsifiers (e.g. iter-37 ProseEditor cited 4 AGENTS.md anti-patterns as falsifiers) provide above-average coverage. |
