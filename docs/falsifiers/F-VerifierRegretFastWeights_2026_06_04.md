...
- Artifact: `artifacts/falsifiers/verifier_regret_fast_weights/result.json`
- L1 next cursor at landing: `F-FastWeightQuarantine`; current cursor after the DepthLeaseCheckpoint witness: `F-ShadowWakeOracle`
