...
| `W-Validator-MigrationIdentitySlugGrammarNegative` | TBD validator-implementation terminal | Any executable validator accepts plus-bearing, colon-bearing, slash-bearing, comma-bearing, spaced, dotted, underscore, uppercase, title-case, boundary-punctuation, empty-token, or numeric-leading identity-gap slug aliases. | Keep N197/N198/N199/N200/N201/N202/N203/N204/N205/N206/N207/N208 failing so identity-gap slug references use only lowercase hyphenated catalog tokens. |
