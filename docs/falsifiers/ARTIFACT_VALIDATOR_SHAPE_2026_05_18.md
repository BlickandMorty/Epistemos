...
| `W-Validator-MigrationIdentitySlugGrammarNegative` | TBD validator-implementation terminal | Any executable validator accepts underscore, uppercase, title-case, or boundary-punctuation identity-gap slug aliases. | Keep N197/N198/N199/N200 failing so identity-gap slug references use only lowercase hyphenated catalog tokens. |
