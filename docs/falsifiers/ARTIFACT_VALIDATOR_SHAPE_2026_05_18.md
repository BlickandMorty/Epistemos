...
| `W-Validator-MigrationIdentitySlugGrammarNegative` | TBD validator-implementation terminal | Any executable validator accepts dotted, underscore, uppercase, title-case, boundary-punctuation, empty-token, or numeric-leading identity-gap slug aliases. | Keep N197/N198/N199/N200/N201/N202/N203 failing so identity-gap slug references use only lowercase hyphenated catalog tokens. |
