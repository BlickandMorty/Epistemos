...
| `W-Validator-MigrationIdentitySlugGrammarNegative` | TBD validator-implementation terminal | Any executable validator accepts underscore, uppercase, or title-case identity-gap slug aliases. | Keep N197/N198 failing so identity-gap slug references use only lowercase hyphenated catalog tokens. |
