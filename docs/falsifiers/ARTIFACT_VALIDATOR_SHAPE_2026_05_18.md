...
| `W-Validator-MigrationIdentitySentinelGapNegativeCases` | TBD validator-implementation terminal | Any executable validator omits one of the identity sentinel gap negative fixtures. | Keep missing, embedded, unlabeled, reserved, comma-bearing, uppercase, identical-impact, detached-artifact, missing-old-new, half-old-new, swapped-half-old-new, empty-old-state, empty-new-state, reversed-old-new, nested-old-marker, nested-new-marker, leading-dot-state, and leading-hyphen-state identity gap examples failing before migration acceptance. |
