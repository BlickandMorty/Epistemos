...
- Current cursor after the 2026-06-05 `F-SmallModelRuntimeHarnessFreshProductRuntimeLiveProbe`: `small_model_runtime_harness_fresh_product_runtime_answer_packet_probe`. This advances L1 live-sidecar proof only; L2 product capability remains `vault_research_route_with_packetized_mitigation`, and L3 fresh app runtime remains unchanged until fresh product AnswerPacket packaging/WRV passes.
