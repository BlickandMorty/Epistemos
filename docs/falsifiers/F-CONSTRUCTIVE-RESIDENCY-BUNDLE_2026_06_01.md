...
- Current cursor after the 2026-06-05 `F-SmallModelRuntimeHarnessFreshProductRuntimeWrvProbe`: `small_model_runtime_harness_fresh_product_runtime_capability_recheck`. This advances L1/L3-source WRV only; L2 product capability remains `vault_research_route_with_packetized_mitigation`, and broader fresh app runtime capability remains unchanged until the fresh capability recheck passes.
