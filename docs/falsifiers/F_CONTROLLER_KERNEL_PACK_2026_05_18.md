...
| 2026-05-27 preflight | `EpistemosTests/MetalWitnessGatesTests.swift` dispatches all six Metal micro-kernels on deterministic fixtures and compares them with scalar references. This is preflight evidence only; the p99 latency, sequence wall-time, and full fixture artifact are still pending. |
