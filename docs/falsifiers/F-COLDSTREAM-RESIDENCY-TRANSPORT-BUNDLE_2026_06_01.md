...
Current cursor after the 2026-06-05 `F-SmallModelRuntimeHarnessAbortableRuntimeProbe` metadata-only abort-path witness: `small_model_runtime_harness_logged_runtime_smoke`.
