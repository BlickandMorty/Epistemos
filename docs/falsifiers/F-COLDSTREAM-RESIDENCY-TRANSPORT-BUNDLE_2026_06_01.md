...
Current cursor after the 2026-06-05 `F-SmallModelRuntimeHarnessOwnerApprovedProbe` metadata-only owner-approval witness: `small_model_runtime_harness_abortable_runtime_probe`.
