...
Current cursor after the 2026-06-05 `F-SmallModelRuntimeHarnessLoggedRuntimeSmoke` metadata-only missing-snapshot logging witness: `small_model_runtime_harness_first_token_runtime_probe`.
