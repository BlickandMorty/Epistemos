...
Current cursor after the 2026-06-05 `F-SmallModelRuntimeHarnessFreshProductRuntimeL3CapabilityCloseoutProbe`: `small_model_runtime_harness_fresh_product_runtime_l3_release_audit_preflight_probe`.
