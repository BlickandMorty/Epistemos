...
Invalid witness shapes, including schema-required axis-floor, anomaly severity, migration-note, and hardware-pin-shape failures, are cataloged in [Artifact Negative Examples](ARTIFACT_NEGATIVE_EXAMPLES_2026_05_18.md). Validator work must keep these examples failing unless a future schema migration explicitly rewrites the violated rule.
