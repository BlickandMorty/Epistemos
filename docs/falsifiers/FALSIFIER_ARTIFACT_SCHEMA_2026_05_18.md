      ...
      "allOf": [
        {
          ...
          "then": {
            "pattern": "(?=.*anomaly_inspection=complete)(?=.*reviewer=[A-Za-z0-9._-]+)"
          }
        },
        {
          "if": {
