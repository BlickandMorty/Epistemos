...
| `F-AxiomAxiomatic-SourceDistinction` | Current active cursor: Axiom AXLE/Axplorer construction motifs, Axiomatic AxProver/OProver proof-agent motifs, Harmonic artifacts, and Math Inc/OpenGauss workflows remain distinct source classes. | Source-card fixture plus false-merge negative. |
