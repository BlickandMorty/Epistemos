...
| `F-SparseWakeCertificate-AnswerPacket` | Current active cursor: selected sparse/KV units, budgets, verifier/citation/test results, traces, uncertainty, fallback, and rollback must be exposed in an AnswerPacket-bound certificate. | Certificate fixture plus visible proof table. |
