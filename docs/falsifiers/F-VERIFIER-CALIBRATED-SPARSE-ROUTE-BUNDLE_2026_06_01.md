...
| `F-QueryAwareKVSelector` | Current active cursor: query-aware KV/page selection beats full-random, recency-only, and file-order baselines on held-out long-context fixtures. | Long-context fixture plus recall/latency table. |
