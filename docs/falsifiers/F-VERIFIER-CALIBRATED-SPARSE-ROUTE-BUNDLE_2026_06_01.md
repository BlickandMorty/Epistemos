...
| `F-ConstructionSearchTournament` | Current active cursor: PatternBoost/Axplorer-style generate-repair-score-select improves sparse wake plans over random generation under a fixed budget. | Tiny tournament fixture plus duplicate/exploration metrics. |
