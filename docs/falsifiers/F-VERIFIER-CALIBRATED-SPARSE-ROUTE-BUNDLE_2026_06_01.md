...
| `F-FastWeightQuarantine` | Current active cursor: fast-weight deltas remain shadow-only until drift, held-out, rollback, TTL, reset, RunEventLog, and AnswerPacket gates pass. | Quarantine state machine plus live-control rejection case. |
