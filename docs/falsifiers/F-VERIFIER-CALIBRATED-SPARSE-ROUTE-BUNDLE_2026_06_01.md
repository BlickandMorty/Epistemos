...
| `F-VerifierBudgetAuction` | Current active cursor: candidate units compete under a verifier, byte, and latency budget, and the auction rejects over-budget bundles before execution. | Budgeted selection fixture with over-budget negative. |
