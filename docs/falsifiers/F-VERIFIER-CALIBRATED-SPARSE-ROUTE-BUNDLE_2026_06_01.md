...
| `F-RouteDistillationTournament` | Current active cursor: expensive full/proof/oracle traces produce held-out route labels that improve the small scout over direct heuristics. | Trace-to-label dataset plus train/held-out split and baseline comparison. |
