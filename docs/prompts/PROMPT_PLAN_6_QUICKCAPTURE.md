...
BUILD ORDER (surface the existing cores; verify-then-build each):
  ...
  (4) 🛑 [OWNER-REMOVED 2026-06-30 — do NOT build; owner removed triage; if Plan 6 is ever activated, SKIP this item] REVIEW QUEUE / TRIAGE HUD (⌘.) — low-confidence/deferred captures (route Variant-D) land in _inbox/review/; keyboard-driven batch-triage HUD; accept updates medoid + alias.
