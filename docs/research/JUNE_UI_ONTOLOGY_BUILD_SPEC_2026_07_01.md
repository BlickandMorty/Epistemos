...
> 🔴 **SUPERSEDED 2026-07-06 — DO NOT BUILD FROM THIS.** This was the operative spec for the
> "make the agent surface structurally = June" port, which failed across earlier rounds.
> Current surfaces are **MAS/June** and **Experimental/1Code**. OpenChamber/ProAgent are deletion
> targets. Keep this doc only for June's token/component study for the MAS surface; do not use
> any OpenChamber-specific framing as a build directive.
