...
with raw failure/domain strings bounded before trimming or punctuation validation; write-error LocalizedError descriptions
are bounded at the source before any SwiftUI status layer can render them.
