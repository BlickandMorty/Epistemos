...
| SS-W | RECENT CRASH + LOG STUDY (owner 2026-06-19) — study DiagnosticReports + app logs (llama-completion inference crashes + any others), root-cause + add fixes to plan | ☐ |
