...
public struct CustomTheme: Codable, Equatable, Sendable {
    ...
    public static var lightDefault: CustomTheme {
        CustomTheme(
            ...
            // Epistemos cream/monospace palette (owner reskin, queue 0.1 / plan §1765):
            // #fbfaf5 / #f4f3ee surfaces, #1c1c1e ink text, ink accent. Edited at the
            // VENDORED SOURCE (not runtime applyCustomTheme) so Osaurus views render it natively.
            colors: ThemeColors(
                primaryText: "#1c1c1e",
                secondaryText: "#48484a",
                tertiaryText: "#6c6c70",
                primaryBackground: "#fbfaf5",
                secondaryBackground: "#f4f3ee",
                tertiaryBackground: "#ecebe4",
                sidebarBackground: "#f4f3ee",
                sidebarSelectedBackground: "#e6e4da",
                accentColor: "#1c1c1e",
                accentColorLight: "#3a3a3c",
                primaryBorder: "#d8d6cc",
                secondaryBorder: "#e6e4da",
                focusBorder: "#1c1c1e",
                successColor: "#15803d",
                warningColor: "#a16207",
                errorColor: "#dc2626",
                infoColor: "#48484a",
                cardBackground: "#fbfaf5",
                cardBorder: "#d8d6cc",
                buttonBackground: "#1c1c1e",
                buttonBorder: "#1c1c1e",
                inputBackground: "#fbfaf5",
                inputBorder: "#cfcdc2",
                glassTintOverlay: "#fbfaf550",
                codeBlockBackground: "#f0eee5",
                shadowColor: "#1c1c1e",
                selectionColor: "#1c1c1e33",
                cursorColor: "#1c1c1e",
                placeholderText: "#8a8a85"
            ),
            background: .default,
            glass: ThemeGlass(
                enabled: false,
            ...
            // Monospace discipline for the cream reskin (owner: "cream/monospace").
            typography: ThemeTypography(primaryFont: "SF Mono"),
            animationConfig: .default,
            shadows: ThemeShadows(
                shadowOpacity: 0.05,
                cardShadowRadius: 8,
