...
extension AgentViewModel {
    ...
    /// Find the last word-boundary occurrence of the Epistemos wake word,
    /// keeping Agent as a compatibility alias for existing users.
    private static func wakeWordAnchor(in transcription: String) -> String.Index? {
        let lower = transcription.lowercased()
        let wakes = ["epistemos!", "epistemos", "agent!", "agent"]
