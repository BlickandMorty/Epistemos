...
extension AgentViewModel {
    ...
    static func formatTCCError(originalOutput: String, kind: TCCRequirement) -> String {
        ...
        case .automation:
            permName = "Automation"
            permPath = "System Settings → Privacy & Security → Automation → Epistemos"
            why = "needed for sending Apple Events to the target app — the user must approve Epistemos controlling that specific app"
