...
extension AgentViewModel {
    ...
    func handleAboutSelfTool(name: String, input: [String: Any]) async -> String? {
        ...
        case "tools":
            aboutText = """
            \(detailPrefix) Epistemos Tools Overview

            Epistemos uses consolidated action-based tools for macOS automation:
        ...
        case "features":
            aboutText = """
            \(detailPrefix) Epistemos Features
        ...
        case "scripting":
            aboutText = """
            \(detailPrefix) Epistemos Scripting Guide

            SWIFT AGENTSCRIPTS:
            Epistemos can compile and run Swift scripts with full TCC permissions.
        ...
        case "automation":
            aboutText = """
            \(detailPrefix) Epistemos Automation Capabilities

            APP CONTROL:
            Epistemos can control macOS apps using:
            ...
            SECURITY:
            All automation inherits Epistemos's TCC permissions
        ...
        case "coding":
            aboutText = """
            \(detailPrefix) Epistemos Coding Assistance
            ...
            BEST PRACTICES:
            Epistemos prefers native tools over shell commands
        ...
        default: // "all"
            ...
            aboutText = """
            \(detailPrefix) Epistemos for macOS 26

            I'm Epistemos — a local AI workbench that lives on your Mac.
            I act autonomously under least privilege. I use an Epistemos user helper
            ...
            Root access via the Epistemos privileged helper is a last resort — only for
            operations that truly require it.

            EPISTEMOS USER HELPER (primary):
            ...
            - Full TCC permissions inherited from Epistemos
            ...
            EPISTEMOS PRIVILEGED HELPER (last resort):
