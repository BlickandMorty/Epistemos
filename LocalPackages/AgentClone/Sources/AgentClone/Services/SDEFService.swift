...
final class SDEFService: @unchecked Sendable {
    ...
    func load(_ name: String) -> SDEFDocument? {
        ...
        guard let url = Bundle.module.url(forResource: name, withExtension: "json", subdirectory: "SDEFs") else {
            return nil
        }
    ...
    func availableSDEFs() -> [String] {
        guard let url = Bundle.module.url(forResource: "SDEFs", withExtension: nil),
