...
struct LLMOutputTextView: NSViewRepresentable {
    ...
    func updateNSView(_ scrollView: NSScrollView, context: Context) {
        ...
        // Epistemos pixel-art reskin: flat off-white instead of the green-phosphor CRT look.
        ...
        // JetBrains Mono (host-registered) for body/code; falls back to system mono if absent.
        let font = NSFont(name: "JetBrainsMono-Regular", size: 16.5)
            ?? NSFont.monospacedSystemFont(ofSize: 16.5, weight: .regular)
