...
struct MessagesView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("Monitor iMessage for \"Epistemos\" commands.")
            ...
            if viewModel.filteredRecipients.isEmpty {
                ...
                HStack {
                    Text("Check recipients to act on \"Epistemos\" commands:")
                        .font(AgentSkin.mono(11))
                        .foregroundStyle(.secondary)
                    Spacer()
                    Button("All") {
            ...
            VStack(alignment: .leading, spacing: 4) {
                Text("Send \"Epistemos <prompt>\" from a checked recipient to trigger a task.")
                    .font(AgentSkin.mono(11))
                    .foregroundStyle(.secondary)
