...
struct HeaderStatusView: View {
    ...
    var body: some View {
        HStack(spacing: 12) {
            ...
            .help("User helper: \(viewModel.userServiceActive ? "Running" : (viewModel.userEnabled ? "Stopped" : "Disabled"))")
            .accessibilityElement(children: .combine)
            .accessibilityLabel("User helper")
            ...
            .help("Privileged helper: \(viewModel.rootServiceActive ? "Running" : (viewModel.rootEnabled ? "Stopped" : "Disabled"))")
            .accessibilityElement(children: .combine)
            .accessibilityLabel("Privileged helper")
