    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            if viewModel.selectedProvider == .claude {
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        HStack(spacing: 6) {
                            Text("API Key or OAuth Token").font(AgentSkin.pixel(11)).foregroundStyle(.secondary)
                            if ClaudeService.isOAuthToken(viewModel.apiKey) {
                                Text("OAuth (subscription)")
                                    .font(AgentSkin.pixel(10)).bold()
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        Text("Model").font(AgentSkin.pixel(11)).foregroundStyle(.secondary)
                        HStack {
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        Text("API Key").font(AgentSkin.pixel(11)).foregroundStyle(.secondary)
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        Text("API Protocol").font(AgentSkin.pixel(11)).foregroundStyle(.secondary)
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        Text("API Key (optional)").font(AgentSkin.pixel(11)).foregroundStyle(.secondary)
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        Text("Endpoint").font(AgentSkin.pixel(11)).foregroundStyle(.secondary)
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        Text("Authentication").font(AgentSkin.pixel(11)).foregroundStyle(.secondary)
                        ...
                        Text("Codex uses your ChatGPT Plus/Pro/Business/Edu/Enterprise subscription for billing. Sign In launches `codex login` in Terminal — complete the browser OAuth flow, then return here. Epistemos reads `~/.codex/auth.json`; tokens refresh automatically.")
                            .font(AgentSkin.mono(10))
                            .foregroundStyle(.secondary)
                            .fixedSize(horizontal: false, vertical: true)
                    }
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        Text("Context Window").font(AgentSkin.pixel(11)).foregroundStyle(.secondary)
                        HStack {
            ...
            if viewModel.selectedProvider != .localOllama && viewModel.selectedProvider != .foundationModel {
                Divider()
                VStack(alignment: .leading, spacing: 4) {
                    Text("Max Output Tokens").font(AgentSkin.pixel(11)).foregroundStyle(.secondary)
                    HStack {
            ...
            VStack(alignment: .leading, spacing: 4) {
                HStack {
                    Text("Temperature").font(AgentSkin.pixel(11)).foregroundStyle(.secondary)
                    Spacer()
                    Text(viewModel.selectedProvider.displayName).font(AgentSkin.pixel(11)).foregroundStyle(.secondary)
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                Text("Exa or Tavily provides web search for all LLM providers. DuckDuckGo is used when neither key is set.")
                    ...
                    .foregroundStyle(.secondary)
                VStack(alignment: .leading, spacing: 4) {
                    Text("Exa API Key").font(AgentSkin.pixel(11)).foregroundStyle(.secondary)
                    LockedSecureField(text: $viewModel.exaAPIKey, placeholder: "exa-...", lockKey: "lock.exaAPIKey")
                }
                VStack(alignment: .leading, spacing: 4) {
                    Text("Tavily API Key").font(AgentSkin.pixel(11)).foregroundStyle(.secondary)
            ...
            HStack {
                Text("Force Vision").font(AgentSkin.pixel(11))
                Spacer()
