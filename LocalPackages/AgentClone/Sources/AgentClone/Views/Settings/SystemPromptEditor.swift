...
struct PromptEditor: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> NSScrollView {
        ...
        textView.font = NSFont(name: "JetBrainsMono-Regular", size: 12) ?? NSFont.monospacedSystemFont(ofSize: 12, weight: .regular)
...
private class PromptLineNumberRuler: NSRulerView {
    ...
    private let gutterFont = NSFont(name: "JetBrainsMono-Regular", size: 11) ?? NSFont.monospacedSystemFont(ofSize: 11, weight: .regular)
...
struct SystemPromptsView: View {
    ...
    private let fullColor = Color(white: 0.9) // Flat off-white (was terminal green)
    private let fullNSColor = NSColor(white: 0.9, alpha: 1.0)
