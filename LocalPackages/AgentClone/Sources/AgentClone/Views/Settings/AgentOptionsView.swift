...
struct AgentOptionsView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            row {
                Text("Iterations").font(AgentSkin.pixel(12))
                Spacer()
                VStack(alignment: .trailing, spacing: 2) {
                    Text("Max per task").font(AgentSkin.mono(11)).foregroundStyle(.secondary)
                    Stepper(
            ...
            row {
                Text("Retries").font(AgentSkin.pixel(12))
                Spacer()
                VStack(alignment: .trailing, spacing: 2) {
                    Text("On server/timeout errors").font(AgentSkin.mono(11)).foregroundStyle(.secondary)
                    Stepper(
            ...
            row {
                Text("Network Retry").font(AgentSkin.pixel(12))
                Spacer()
                VStack(alignment: .trailing, spacing: 2) {
                    Text("Seconds between retries").font(AgentSkin.mono(11)).foregroundStyle(.secondary)
            ...
            row {
                Text("Output").font(AgentSkin.pixel(12))
                Spacer()
                VStack(alignment: .trailing, spacing: 2) {
                    Text("Lines before truncated").font(AgentSkin.mono(11)).foregroundStyle(.secondary)
                    Stepper(
            ...
            row {
                Text("Read File").font(AgentSkin.pixel(12))
                Spacer()
                VStack(alignment: .trailing, spacing: 2) {
                    Text("Preview lines").font(AgentSkin.mono(11)).foregroundStyle(.secondary)
                    Stepper(
            ...
            row {
                Text("Epistemos Scripts").font(AgentSkin.pixel(12))
                Spacer()
            ...
            row {
                Text("Task Input").font(AgentSkin.pixel(12))
                Spacer()
            ...
            row {
                Text("History").font(AgentSkin.pixel(12))
                Spacer()
                VStack(alignment: .trailing, spacing: 2) {
                    Text("Summarize after").font(AgentSkin.mono(11)).foregroundStyle(.secondary)
                    Stepper(
                ...
                VStack(alignment: .trailing, spacing: 2) {
                    Text("Visible in chat").font(AgentSkin.mono(11)).foregroundStyle(.secondary)
                    Stepper(
            ...
            row {
                VStack(alignment: .leading, spacing: 2) {
                    Text("Shell").font(AgentSkin.pixel(12))
                    Text("In-process + user helper + privileged helper")
            ...
            row {
                Text("Token Budget").font(AgentSkin.pixel(12))
                Spacer()
                HStack(spacing: 8) {
                    Toggle("", isOn: Binding(
