...
extension ActivityLogView.Coordinator {
    ...
    nonisolated static func styleTrimBanner(_ rendered: NSAttributedString, font: NSFont) -> NSAttributedString {
        ...
        mutable.addAttributes([
            .font: NSFont(name: "JetBrainsMono-Regular", size: font.pointSize - 1) ?? NSFont.monospacedSystemFont(ofSize: font.pointSize - 1, weight: .medium),
            .foregroundColor: AgentSkin.nsTextDim,
