...
// NOTE: `@main` removed for library form — a library has no entry point.
// The scene struct is preserved verbatim so all referencing code still
// compiles; Epistemos mounts `ContentView` directly (see `public init` below).
struct AgentApp: App {
