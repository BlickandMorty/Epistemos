...
struct JuneAgentNavBar: View {
    ...
    @State private var showingJuneSettings = false
    ...
    var body: some View {
        HStack(spacing: 6) {
            ...
            .background(theme.textPrimary.opacity(theme.isDark ? 0.07 : 0.045), in: Capsule())
            .help("June Settings")
            .accessibilityLabel("June Settings")
            .sheet(isPresented: $showingJuneSettings) {
                JuneCloudSettingsView()
            }
