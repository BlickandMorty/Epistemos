...
nonisolated enum LocalAgentPromptBuilder {
    static func systemPrompt(
        ...
        If fused search exact_escalation_reasons includes top_hit_source_rank_only or top_hit_no_visible_evidence_reason, treat the top hit as ungrounded until exact verification returns visible evidence.
        ...
        If fused search metadata says uses_current_contract_shape=false, treat the retrieval trace as stale; exact-verify again or say the vault evidence is insufficient.
