...
struct LandingView: View {
                    ...
                    HStack(alignment: .center, spacing: LandingSearchLayout.controlRowSpacing) {
                        ToolbarMorphHost(style: .composerControls, baseSurface: .none) {
                            HStack(spacing: LandingSearchLayout.controlRowSpacing) {
                                ResearchModeControl(
                                    variant: .toolbar,
                                    toggleMorphID: LandingToolbarMorphID.research.rawValue,
                                    optionsMorphID: LandingToolbarMorphID.researchOptions.rawValue
                                )

                                landingHistoryButton
    ...
    private var landingHistoryButton: some View {
        @Bindable var ui = ui

        return AnchoredPopoverButton(
            title: "History",
            ...
            morphID: LandingToolbarMorphID.history.rawValue
        ) {
            ChatSidebarView()
