...
extension GraphEdgeType {
    var displayName: String {
        ...
        case .producedDuring: return "Produced During"  // Patch 5: Raw Thoughts edges
    ...
    var icon: String {
        ...
        case .producedDuring: return "stopwatch"  // Patch 5: Raw Thoughts edges
        case .generatedBy:    return "sparkles"
        case .derivedFrom:    return "arrow.uturn.left"
        case .summarizes:     return "doc.text"
        }
    }
