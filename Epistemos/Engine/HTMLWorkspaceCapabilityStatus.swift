...
enum HTMLWorkspaceCapabilityStatus {
    ...
    static let capabilities: [Capability] = [
        ...
        Capability(name: "Full-surface regenerate", isLive: false, note: "replaceDocument/regenerate patch plumbing exists, with one-click stream-to-preview/apply, visible revert, presets, advanced manual fallback, workspace-context grounding, preview-side context rail, and selected-preview drop targets; awaits current in-app proof"),
