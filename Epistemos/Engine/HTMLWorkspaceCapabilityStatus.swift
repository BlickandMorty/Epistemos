...
enum HTMLWorkspaceCapabilityStatus {
    ...
    static let capabilities: [Capability] = [
        ...
        Capability(name: "Python (Pyodide / WASM)", isLive: false, note: "Build-vendored Pyodide assets, sandbox-gated runtime path, bounded and serialized run input, retry-safe loader, local/blob worker CSP, insertable demo scaffold, and runtime probe are wired; awaits current in-app proof"),
    ]
