...
enum HTMLWorkspaceCapabilityStatus {
    ...
    static let capabilities: [Capability] = [
        ...
        Capability(name: "DOM picker / style inspector", isLive: false, note: "Click-pick inspector bridge, hover-highlighted picker, element-normalized event targets, escaped selector copy, nth-of-type focused selectors, style payload parser, focused style edits, and open-panel probe path are wired; awaits current in-app proof"),
