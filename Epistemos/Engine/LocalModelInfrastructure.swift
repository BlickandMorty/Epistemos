...
enum LocalModelCatalog {
    nonisolated static let textDescriptors: [LocalModelDescriptor] = [
        ...
        LocalModelDescriptor(
            ...
            summary: "Gemma 4 E4B (MLX, native Apple Swift loader). Runnable via the same dense Gemma4Text port as E2B; E2B is the active on-device validation tier, so E4B is not in the install baseline yet — not a shipping route default.",
        ...
        LocalModelDescriptor(
            ...
            summary: "Gemma 4 26B-A4B preview weights (Mixture-of-Experts). The dense Gemma4Text Swift loader can't run it — no Router/Experts path — so it stays gated and is not a shipping route. A separate MoE loader is required.",
