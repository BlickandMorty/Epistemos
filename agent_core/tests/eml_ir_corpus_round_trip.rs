...
pub fn corpus_iter_14() -> Vec<CorpusEntry> {
    ...
    out.push(CorpusEntry {
        ...
        tree: e(e(one(), e(one(), one())), e(one(), e(one(), one()))),
    ...
    out.push(CorpusEntry {
        ...
        tree: e(e(e(one(), one()), one()), e(one(), e(one(), one()))),
    ...
    out.push(CorpusEntry {
        ...
        tree: e(e(one(), one()), e(e(one(), one()), e(one(), one()))),
    ...
    out.push(CorpusEntry {
        ...
        tree: e(e(e(one(), one()), one()), e(e(one(), one()), one())),
    ...
    out.push(CorpusEntry {
        ...
        tree: e(e(one(), e(one(), one())), e(e(one(), one()), one())),
    ...
    out.push(CorpusEntry {
        ...
        tree: e(one(), e(e(one(), e(one(), one())), e(one(), one()))),
    ...
    out.push(CorpusEntry {
        ...
        tree: e(one(), e(e(one(), one()), e(e(one(), one()), one()))),
    ...
    out.push(CorpusEntry {
        ...
        tree: e(e(one(), one()), e(e(one(), e(one(), one())), one())),
    ...
    out.push(CorpusEntry {
        ...
        tree: e(e(e(one(), e(one(), one())), e(one(), one())), one()),
    ...
    out.push(CorpusEntry {
        ...
        tree: e(e(one(), e(one(), e(one(), e(one(), one())))), one()),
    ...
    out.push(CorpusEntry {
        ...
        tree: e(
            one(),
            e(e(one(), one()), e(e(one(), e(one(), one())), one())),
        ),
    ...
    out.push(CorpusEntry {
        ...
        tree: e(e(e(one(), one()), e(one(), one())), e(one(), one())),
    ...
    out.push(CorpusEntry {
        ...
        tree: e(e(one(), e(e(one(), one()), e(one(), one()))), one()),
    ...
    out.push(CorpusEntry {
        ...
        tree: e(e(one(), e(one(), e(one(), one()))), e(one(), one())),
        reference: exp_e_minus_1 - 1.0,
        tolerance: 1e-9,
    });
    ...
    out.push(CorpusEntry {
        ...
        tree: e(one(), e(e(one(), e(one(), e(one(), one()))), one())),
        reference: 1.0,
        tolerance: 1e-12,
    });
    ...
    out.push(CorpusEntry {
        ...
        tree: e(e(e(one(), one()), e(one(), e(one(), one()))), one()),
        reference: v_d4_big,
    ...
    out.push(CorpusEntry {
        ...
        tree: e(e(one(), one()), e(e(e(one(), one()), one()), one())),
        reference: 0.0,
        tolerance: 1e-9,
    });
    ...
    out.push(CorpusEntry {
        ...
        tree: e(e(one(), e(e(one(), one()), one())), e(one(), one())),
    ...
    out.push(CorpusEntry {
        name: "deep-log-chain",
        tree: e(one(), e(one(), e(e(one(), one()), e(one(), one())))),
    ...
    out.push(CorpusEntry {
        ...
        tree: e(
            e(one(), one()),
            e(one(), e(e(one(), e(one(), one())), e(one(), one()))),
        ),
...
pub fn corpus_iter_15() -> Vec<CorpusEntry> {
    ...
    for (i, tree) in depth5_shapes.into_iter().enumerate() {
        ...
        let leaked: &'static str = Box::leak(format!("d5-shape-{:03}", i).into_boxed_str());
        out.push(CorpusEntry {
            name: leaked,
            tree,
            reference,
...
fn iter_14_entries_have_unique_names() {
    let c = corpus_iter_14();
    let names: std::collections::HashSet<&'static str> = c.iter().map(|e| e.name).collect();
    assert_eq!(
        names.len(),
        c.len(),
