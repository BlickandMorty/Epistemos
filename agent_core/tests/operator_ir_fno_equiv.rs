...
// Salvage note (2026-05-23): on the cherry-picked operator_ir from
// codex/t5-emlir-2026-05-16, `OperatorExpr::new(.., modes=0)` returns
// `Err(FourierModesZero)` — the substrate rejects zero-mode fixtures.
// This test predates that rejection; ignored until the substrate
// invariant is reconciled in a follow-up.
#[ignore = "salvage: zero-mode rejection postdates this fixture"]
#[test]
