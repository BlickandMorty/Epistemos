...
pub const GRAPH_FILTER_VISIBILITY_FOCUSED_PROOF_ROOT_OWNER_APPROVAL_COMMAND_CARD_REF: &str =
...
pub const GRAPH_FILTER_VISIBILITY_FOCUSED_PROOF_ROOT_OWNER_APPROVAL_EXECUTION_GATE_REF: &str =
    "artifact:falsifiers/graph_filter_visibility_focused_proof_root_execution_artifact_gate/result.json#F-GraphFilterVisibilityFocusedProofRootExecutionArtifactGate";
