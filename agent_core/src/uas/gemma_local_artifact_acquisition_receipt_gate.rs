...
pub const GEMMA_LOCAL_ARTIFACT_ACQUISITION_RECEIPT_GATE_UPSTREAM_REF: &str =
    "artifact:falsifiers/gemma_local_artifact_acquisition_command_card/result.json#F-GemmaLocalArtifactAcquisitionCommandCard";
