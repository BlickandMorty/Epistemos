//! Small-model runtime harness fresh product-runtime WRV probe.
//!
//! This L1/L3-source witness proves that the fresh small-model product-runtime
//! AnswerPacket evidence is wired into the app's product route surfaces with
//! WRV source evidence. It remains metadata/source proof only: it does not run
//! inference again, open model bytes, promote MAS live-agent claims, or mark the
//! capability kernel green.
...
pub const SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_WRV_PROBE_CURSOR: &str =
    "small_model_runtime_harness_fresh_product_runtime_wrv_probe";
pub const SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_WRV_PROBE_NEXT_CURSOR: &str =
...
// UAS: uas:small-model-runtime-harness-fresh-product-runtime-wrv-probe:phase
// Plane: Controller + Verification
// Residency: source-level fresh product-runtime WRV phase.
pub enum SmallModelFreshProductRuntimeWrvPhase {
    FreshAnswerPacketArtifactBound,
    FreshRunEventLogArtifactBound,
    ProductRouteWired,
    ProductSurfaceReachable,
    VisiblePacketSurfaceBound,
    SettingsDiagnosticsBound,
    SystemGReplayBound,
    SerialControllerSafetyBound,
    TriagePolicyVerified,
    AnswerPacketVerified,
    FreshRuntimeEvidenceVerified,
    CapabilityHonestyBound,
}

impl SmallModelFreshProductRuntimeWrvPhase {
    pub fn tag(&self) -> &'static str {
        match self {
            Self::FreshAnswerPacketArtifactBound => "fresh_answer_packet_artifact_bound",
            Self::FreshRunEventLogArtifactBound => "fresh_run_event_log_artifact_bound",
            Self::ProductRouteWired => "product_route_wired",
            Self::ProductSurfaceReachable => "product_surface_reachable",
            Self::VisiblePacketSurfaceBound => "visible_packet_surface_bound",
            Self::SettingsDiagnosticsBound => "settings_diagnostics_bound",
            Self::SystemGReplayBound => "system_g_replay_bound",
            Self::SerialControllerSafetyBound => "serial_controller_safety_bound",
            Self::TriagePolicyVerified => "triage_policy_verified",
            Self::AnswerPacketVerified => "answer_packet_verified",
            Self::FreshRuntimeEvidenceVerified => "fresh_runtime_evidence_verified",
...
// UAS: uas:small-model-runtime-harness-fresh-product-runtime-wrv-probe:error
// Plane: Verification
// Residency: source/fresh product-runtime WRV rejection taxonomy.
pub enum SmallModelFreshProductRuntimeWrvProbeError {
...
impl fmt::Display for SmallModelFreshProductRuntimeWrvProbeError {
...
impl std::error::Error for SmallModelFreshProductRuntimeWrvProbeError {}

#[derive(Clone, Debug)]
// UAS: uas:small-model-runtime-harness-fresh-product-runtime-wrv-probe:source-ref
// Plane: Verification
// Residency: source marker proving one fresh product-runtime route dependency.
pub struct SmallModelFreshProductRuntimeWrvSourceRef {
    pub ref_id: String,
    pub path: String,
    pub markers: Vec<String>,
}

impl SmallModelFreshProductRuntimeWrvSourceRef {
    pub fn validate(&self) -> Result<(), SmallModelFreshProductRuntimeWrvProbeError> {
        ...
        if self.markers.len() < MIN_MARKERS_PER_REF {
            return Err(SmallModelFreshProductRuntimeWrvProbeError::MissingMarker(
                self.ref_id.clone(),
            ));
        }
...
#[derive(Clone, Debug)]
// UAS: uas:small-model-runtime-harness-fresh-product-runtime-wrv-probe:test-ref
// Plane: Verification
// Residency: focused verification marker proving WRV tests exist.
pub struct SmallModelFreshProductRuntimeWrvTestRef {
    pub ref_id: String,
    pub path: String,
    pub markers: Vec<String>,
}

impl SmallModelFreshProductRuntimeWrvTestRef {
    pub fn validate(&self) -> Result<(), SmallModelFreshProductRuntimeWrvProbeError> {
...
#[derive(Clone, Debug)]
// UAS: uas:small-model-runtime-harness-fresh-product-runtime-wrv-probe:surface
// Plane: Verification
// Residency: visible app surface and rollback/admission/packet contract for fresh runtime proof.
pub struct SmallModelFreshProductRuntimeWrvSurface {
...
impl SmallModelFreshProductRuntimeWrvSurface {
    pub fn validate(&self) -> Result<(), SmallModelFreshProductRuntimeWrvProbeError> {
        ...
        validate_prefixed(
            ...
            &self.admission_ref,
            ADMISSION_PREFIX,
            SmallModelFreshProductRuntimeWrvProbeError::MissingAdmission,
        )?;
        validate_prefixed(
            &self.surface_id,
            &self.rollback_ref,
            ROLLBACK_PREFIX,
            SmallModelFreshProductRuntimeWrvProbeError::MissingRollback,
        )?;
        validate_prefixed(
            &self.surface_id,
            &self.answer_packet_ref,
            ANSWER_PACKET_PREFIX,
            SmallModelFreshProductRuntimeWrvProbeError::MissingAnswerPacket,
        )?;
        validate_prefixed(
            &self.surface_id,
            &self.run_event_log_ref,
            RUN_EVENT_LOG_PREFIX,
            SmallModelFreshProductRuntimeWrvProbeError::MissingRunEventLog,
        )?;
        validate_prefixed(
            &self.surface_id,
            &self.compatibility_fence_ref,
            COMPATIBILITY_PREFIX,
            SmallModelFreshProductRuntimeWrvProbeError::MissingCompatibilityFence,
        )?;
        validate_prefixed(
            &self.surface_id,
            &self.privacy_ref,
            PRIVACY_PREFIX,
            SmallModelFreshProductRuntimeWrvProbeError::MissingPrivacyFence,
        )?;
        validate_prefixed(
            &self.surface_id,
            &self.budget_ref,
            BUDGET_PREFIX,
            SmallModelFreshProductRuntimeWrvProbeError::MissingBudget,
        )?;
        if !self.visible {
            return Err(SmallModelFreshProductRuntimeWrvProbeError::MissingWrvAxis(
                "visible",
            ));
        }
        if self.hidden_route_authority {
            return Err(
                SmallModelFreshProductRuntimeWrvProbeError::HiddenRouteAuthority(
        ...
        if self.hidden_cloud_fallback {
            return Err(
                SmallModelFreshProductRuntimeWrvProbeError::HiddenCloudFallback(
                    self.surface_id.clone(),
                ),
            );
        }
        if self.hidden_chain_exposed {
            return Err(
                SmallModelFreshProductRuntimeWrvProbeError::HiddenChainExposure(
                    self.surface_id.clone(),
                ),
            );
        }
        if self.route_policy_mutated {
            return Err(
                SmallModelFreshProductRuntimeWrvProbeError::RoutePolicyMutation(
                    self.surface_id.clone(),
                ),
            );
        }
        if self.gate_bypassed {
            return Err(SmallModelFreshProductRuntimeWrvProbeError::GateBypass(
                self.surface_id.clone(),
            ));
        }
        if self.answer_packet_suppressed {
            return Err(
                SmallModelFreshProductRuntimeWrvProbeError::AnswerPacketSuppressed(
                    self.surface_id.clone(),
                ),
            );
        }
        if self.subprocess_spawned_in_app_path {
            return Err(
                SmallModelFreshProductRuntimeWrvProbeError::AppPathSubprocessSpawn(
                    self.surface_id.clone(),
                ),
            );
        }
        if self.autogenous_kernel_attempted {
            return Err(
                SmallModelFreshProductRuntimeWrvProbeError::AutogenousKernelAttempt(
                    self.surface_id.clone(),
                ),
            );
        }
        if self.seventy_b_product_claimed {
            return Err(
                SmallModelFreshProductRuntimeWrvProbeError::SeventyBProductClaim(
                    self.surface_id.clone(),
                ),
            );
        }
        if self.long_context_shard_product_claimed {
            return Err(
                SmallModelFreshProductRuntimeWrvProbeError::LongContextShardProductClaim(
                    self.surface_id.clone(),
                ),
            );
        }
...
#[derive(Clone, Debug)]
// UAS: uas:small-model-runtime-harness-fresh-product-runtime-wrv-probe:metrics
// Plane: Verification
// Residency: aggregate fresh product-runtime WRV source-proof metrics.
pub struct SmallModelFreshProductRuntimeWrvMetrics {
...
#[derive(Clone, Debug)]
// UAS: uas:small-model-runtime-harness-fresh-product-runtime-wrv-probe:witness
// Plane: Controller + Verification
// Residency: source-level app WRV proof for fresh small-model product-runtime routing.
pub struct SmallModelFreshProductRuntimeWrvWitness {
    ...
    pub source_refs: Vec<SmallModelFreshProductRuntimeWrvSourceRef>,
    pub surfaces: Vec<SmallModelFreshProductRuntimeWrvSurface>,
    pub test_refs: Vec<SmallModelFreshProductRuntimeWrvTestRef>,
    pub phases: Vec<SmallModelFreshProductRuntimeWrvPhase>,
    pub wired: bool,
    pub reachable: bool,
    pub visible: bool,
    pub verified: bool,
...
impl SmallModelFreshProductRuntimeWrvWitness {
    ...
    pub fn new(
        ...
        surfaces: Vec<SmallModelFreshProductRuntimeWrvSurface>,
        test_refs: Vec<SmallModelFreshProductRuntimeWrvTestRef>,
        phases: Vec<SmallModelFreshProductRuntimeWrvPhase>,
        wired: bool,
        reachable: bool,
        visible: bool,
        verified: bool,
        ...
        metadata_bytes: u64,
    ) -> Result<Self, SmallModelFreshProductRuntimeWrvProbeError> {
        let witness = Self {
    ...
    pub fn validate(&self) -> Result<(), SmallModelFreshProductRuntimeWrvProbeError> {
        ...
        validate_prefixed(
            ...
            SmallModelFreshProductRuntimeWrvProbeError::MissingAnswerPacketArtifact,
        )?;
        ...
        {
            return Err(SmallModelFreshProductRuntimeWrvProbeError::GuardCursorMismatch);
        }
        ...
        {
            return Err(SmallModelFreshProductRuntimeWrvProbeError::CapabilityStatusMismatch);
        }
        if self.product_build != ProductBuild::Pro
            || self.pro_status != ProStatus::Gated
            || self.route_authority != "fresh_product_runtime_wrv_source_only_no_route_authority"
        {
            return Err(SmallModelFreshProductRuntimeWrvProbeError::ProductStatusMismatch);
        }
        if self.source_refs.is_empty() {
            return Err(SmallModelFreshProductRuntimeWrvProbeError::EmptySourceRef);
        }
        if self.surfaces.is_empty() {
            return Err(SmallModelFreshProductRuntimeWrvProbeError::EmptySurface);
        }
        if self.test_refs.is_empty() {
            return Err(SmallModelFreshProductRuntimeWrvProbeError::EmptyTestRef);
        }
        if self.phases.is_empty() {
            return Err(SmallModelFreshProductRuntimeWrvProbeError::EmptyPhase);
        }
        ...
        for source_ref in &self.source_refs {
            ...
            if !source_ids.insert(source_ref.ref_id.clone()) {
                return Err(
                    SmallModelFreshProductRuntimeWrvProbeError::DuplicateSourceRef(
        ...
        for surface in &self.surfaces {
            ...
            if !surface_ids.insert(surface.surface_id.clone()) {
                return Err(
                    SmallModelFreshProductRuntimeWrvProbeError::DuplicateSurface(
        ...
        for test_ref in &self.test_refs {
            ...
            if !test_ids.insert(test_ref.ref_id.clone()) {
                return Err(
                    SmallModelFreshProductRuntimeWrvProbeError::DuplicateTestRef(
        ...
        let observed_phases = self
            .phases
            .iter()
            .map(SmallModelFreshProductRuntimeWrvPhase::tag)
            .collect::<BTreeSet<_>>();
        for phase in required_fresh_product_runtime_wrv_phases() {
            if !observed_phases.contains(phase.tag()) {
                return Err(SmallModelFreshProductRuntimeWrvProbeError::MissingPhase(
                    phase.tag(),
                ));
            }
        }
        ...
        if self.mas_live_agent_overclaim_attempted {
            return Err(SmallModelFreshProductRuntimeWrvProbeError::MasLiveAgentOverclaim);
        }
        if self.l2_green_claimed {
            return Err(SmallModelFreshProductRuntimeWrvProbeError::L2GreenClaimAttempted);
        }
        if self.l3_runtime_green_claimed {
            return Err(SmallModelFreshProductRuntimeWrvProbeError::L3RuntimeGreenClaimAttempted);
        }
        if self.runtime_bytes_loaded != 0 {
            return Err(SmallModelFreshProductRuntimeWrvProbeError::RuntimeBytesLoaded);
        }
        if self.model_bytes_loaded != 0 {
            return Err(SmallModelFreshProductRuntimeWrvProbeError::ModelBytesLoaded);
        }
        if self.metadata_bytes > MAX_METADATA_BYTES {
            return Err(SmallModelFreshProductRuntimeWrvProbeError::MetadataBudgetExceeded);
        }
        Ok(())
    }

    pub fn metrics(&self) -> SmallModelFreshProductRuntimeWrvMetrics {
        SmallModelFreshProductRuntimeWrvMetrics {
...
pub fn required_fresh_product_runtime_wrv_phases() -> [SmallModelFreshProductRuntimeWrvPhase; 12] {
    [
        SmallModelFreshProductRuntimeWrvPhase::FreshAnswerPacketArtifactBound,
        SmallModelFreshProductRuntimeWrvPhase::FreshRunEventLogArtifactBound,
        SmallModelFreshProductRuntimeWrvPhase::ProductRouteWired,
        SmallModelFreshProductRuntimeWrvPhase::ProductSurfaceReachable,
        SmallModelFreshProductRuntimeWrvPhase::VisiblePacketSurfaceBound,
        SmallModelFreshProductRuntimeWrvPhase::SettingsDiagnosticsBound,
        SmallModelFreshProductRuntimeWrvPhase::SystemGReplayBound,
        SmallModelFreshProductRuntimeWrvPhase::SerialControllerSafetyBound,
        SmallModelFreshProductRuntimeWrvPhase::TriagePolicyVerified,
        SmallModelFreshProductRuntimeWrvPhase::AnswerPacketVerified,
        SmallModelFreshProductRuntimeWrvPhase::FreshRuntimeEvidenceVerified,
        SmallModelFreshProductRuntimeWrvPhase::CapabilityHonestyBound,
    ]
}

pub fn fresh_product_runtime_wrv_metadata_budget_bytes() -> u64 {
    MAX_METADATA_BYTES
}
...
fn validate_prefixed_source(
    ...
    value: &str,
    prefix: &str,
) -> Result<(), SmallModelFreshProductRuntimeWrvProbeError> {
    validate_clean(field, value)?;
    if !value.starts_with(prefix) {
        return Err(SmallModelFreshProductRuntimeWrvProbeError::MissingField(
            field,
        ));
    }
    Ok(())
...
fn validate_prefixed(
    ...
    value: &str,
    prefix: &str,
    error: fn(String) -> SmallModelFreshProductRuntimeWrvProbeError,
) -> Result<(), SmallModelFreshProductRuntimeWrvProbeError> {
...
fn validate_clean(
    ...
    if value.trim() != value {
        return Err(
            SmallModelFreshProductRuntimeWrvProbeError::FieldHasSurroundingWhitespace(field),
        );
    }
    if value.chars().any(|ch| ch.is_control()) {
        return Err(
            SmallModelFreshProductRuntimeWrvProbeError::FieldContainsControlCharacter(field),
        );
    }
    Ok(())
}
...
mod tests {
    ...
    fn source(id: &str) -> SmallModelFreshProductRuntimeWrvSourceRef {
        SmallModelFreshProductRuntimeWrvSourceRef {
    ...
    fn test_ref(id: &str) -> SmallModelFreshProductRuntimeWrvTestRef {
        SmallModelFreshProductRuntimeWrvTestRef {
    ...
    fn surface(id: &str) -> SmallModelFreshProductRuntimeWrvSurface {
        SmallModelFreshProductRuntimeWrvSurface {
            surface_id: format!("surface:{id}"),
            admission_ref: "admission:scope_rex:local_model_fresh_product_runtime_wrv".to_string(),
    ...
    fn witness() -> SmallModelFreshProductRuntimeWrvWitness {
        SmallModelFreshProductRuntimeWrvWitness::new(
            "small-model-fresh-product-runtime-wrv-fixture",
    ...
    #[test]
    fn fresh_product_runtime_wrv_fixture_validates_and_has_deterministic_address() {
        let first = witness();
        let second = witness();
    ...
    fn missing_reachable_axis_is_rejected() {
        let error = SmallModelFreshProductRuntimeWrvWitness::new(
            "small-model-fresh-product-runtime-wrv-fixture",
            "artifact:small_model_runtime_harness_fresh_product_runtime_answer_packet_probe:result",
            SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_WRV_PROBE_CURSOR,
            "vault_research_route_with_packetized_mitigation",
        ...
        assert!(matches!(
            error,
            SmallModelFreshProductRuntimeWrvProbeError::MissingWrvAxis("reachable")
        ));
    }
    ...
    fn runtime_bytes_are_rejected() {
        ...
        assert!(matches!(
            error,
            SmallModelFreshProductRuntimeWrvProbeError::RuntimeBytesLoaded
        ));
    }
    ...
    fn hidden_cloud_is_rejected() {
        ...
        assert!(matches!(
            error,
            SmallModelFreshProductRuntimeWrvProbeError::HiddenCloudFallback(_)
        ));
    }
}
