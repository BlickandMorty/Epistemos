//! Fresh product-runtime AnswerPacket probe for the small-model harness.
//!
//! This L1 witness sits at
//! `small_model_runtime_harness_fresh_product_runtime_answer_packet_probe`. It does not run
//! inference again. It packetizes the fresh product-runtime live sidecar into
...
pub const SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_ANSWER_PACKET_PROBE_CURSOR: &str =
...
const FRESH_LIVE_SIDECAR_PREFIX: &str =
...
// UAS: uas:small-model-runtime-harness-fresh-product-runtime-answer-packet-probe:phase
// Plane: Controller + Verification
// Residency: fresh product-runtime packetization proof phase.
pub enum SmallModelFreshProductRuntimeAnswerPacketPhase {
    FreshLiveArtifactBound,
...
impl SmallModelFreshProductRuntimeAnswerPacketPhase {
    pub fn tag(&self) -> &'static str {
        match self {
            Self::FreshLiveArtifactBound => "fresh_live_artifact_bound",
...
// UAS: uas:small-model-runtime-harness-fresh-product-runtime-answer-packet-probe:error
// Plane: Verification
// Residency: fresh product-runtime packetization rejection taxonomy.
pub enum SmallModelFreshProductRuntimeAnswerPacketProbeError {
    ...
    GuardCursorMismatch,
    MissingFreshLiveArtifact(String),
...
impl fmt::Display for SmallModelFreshProductRuntimeAnswerPacketProbeError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::MissingFreshLiveArtifact(id) => {
                write!(f, "packet `{id}` missing fresh live-probe artifact ref")
            }
            Self::MissingLiveProbeSidecar(id) => {
                write!(f, "packet `{id}` missing fresh live-probe sidecar ref")
            }
...
impl std::error::Error for SmallModelFreshProductRuntimeAnswerPacketProbeError {}

#[derive(Clone, Debug)]
// UAS: uas:small-model-runtime-harness-fresh-product-runtime-answer-packet-probe:surface
// Plane: State + Verification
// Residency: visible canon/source surface evidence.
pub struct SmallModelFreshProductRuntimeAnswerPacketSurface {
...
impl SmallModelFreshProductRuntimeAnswerPacketSurface {
    pub fn new(
    ...
    ) -> Result<Self, SmallModelFreshProductRuntimeAnswerPacketProbeError> {
        let surface = Self {
        ...
        if surface.observed_text.trim().len() < MIN_SURFACE_TEXT_BYTES {
            return Err(SmallModelFreshProductRuntimeAnswerPacketProbeError::EmptySurface);
        }
        for marker in &surface.required_markers {
            validate_clean("required_marker", marker)?;
            if !surface.observed_text.contains(marker) {
                return Err(
                    SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingRequiredMarker(
                        marker.clone(),
                    ),
                );
            }
...
#[derive(Clone, Debug)]
// UAS: uas:small-model-runtime-harness-fresh-product-runtime-answer-packet-probe:packet
// Plane: Controller + Verification
// Residency: packetized fresh product-runtime evidence.
pub struct SmallModelFreshProductRuntimeAnswerPacketPacket {
    pub packet_id: String,
    pub fresh_live_artifact_ref: String,
    ...
    pub phases: Vec<SmallModelFreshProductRuntimeAnswerPacketPhase>,
...
impl SmallModelFreshProductRuntimeAnswerPacketPacket {
    #[allow(clippy::too_many_arguments)]
    pub fn new(
        packet_id: impl Into<String>,
        fresh_live_artifact_ref: impl Into<String>,
        ...
        phases: Vec<SmallModelFreshProductRuntimeAnswerPacketPhase>,
        ...
        let packet = Self {
            ...
            fresh_live_artifact_ref: fresh_live_artifact_ref.into(),
    ...
    pub fn validate(&self) -> Result<(), SmallModelFreshProductRuntimeAnswerPacketProbeError> {
        validate_clean("packet_id", &self.packet_id)?;
        validate_prefixed(
            &self.packet_id,
            &self.fresh_live_artifact_ref,
            FRESH_LIVE_ARTIFACT_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingFreshLiveArtifact,
        )?;
        validate_prefixed(
            &self.packet_id,
            &self.live_probe_sidecar_ref,
            FRESH_LIVE_SIDECAR_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingLiveProbeSidecar,
        )?;
        validate_prefixed(
            &self.packet_id,
            &self.answer_packet_ref,
            ANSWER_PACKET_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingAnswerPacket,
        )?;
        validate_prefixed(
            &self.packet_id,
            &self.run_event_log_ref,
            RUN_EVENT_LOG_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingRunEventLog,
        )?;
        validate_prefixed(
            &self.packet_id,
            &self.run_event_log_root_ref,
            RUN_EVENT_LOG_ROOT_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingRunEventLogRoot,
        )?;
        validate_prefixed(
            &self.packet_id,
            &self.packet_json_ref,
            PACKET_JSON_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingPacketJson,
        )?;
        validate_prefixed(
            &self.packet_id,
            &self.witnessed_state_ref,
            WITNESSED_STATE_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingWitnessedState,
        )?;
        validate_prefixed(
            &self.packet_id,
            &self.mutation_envelope_ref,
            MUTATION_ENVELOPE_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingMutationEnvelope,
        )?;
        validate_prefixed(
            &self.packet_id,
            &self.semantic_delta_ref,
            SEMANTIC_DELTA_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingSemanticDelta,
        )?;
        validate_prefixed(
            &self.packet_id,
            &self.rollback_ref,
            ROLLBACK_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingRollback,
        )?;
        validate_prefixed(
            &self.packet_id,
            &self.admission_ref,
            ADMISSION_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingAdmission,
        )?;
        validate_prefixed(
            &self.packet_id,
            &self.scope_rex_ref,
            SCOPE_REX_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingScopeRex,
        )?;
        validate_prefixed(
            &self.packet_id,
            &self.sovereign_gate_ref,
            SOVEREIGN_GATE_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingSovereignGate,
        )?;
        validate_prefixed(
            &self.packet_id,
            &self.compatibility_fence_ref,
            COMPATIBILITY_FENCE_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingCompatibilityFence,
        )?;
        validate_prefixed(
            &self.packet_id,
            &self.cancellation_ref,
            CANCELLATION_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingCancellation,
        )?;
        validate_prefixed(
            &self.packet_id,
            &self.privacy_ref,
            PRIVACY_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingPrivacyFence,
        )?;
        validate_prefixed(
            &self.packet_id,
            &self.budget_ref,
            BUDGET_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingBudget,
        )?;
        validate_prefixed(
            &self.packet_id,
            &self.token_digest_ref,
            TOKEN_SHA_PREFIX,
            SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingTokenDigest,
        )?;
        if self.token_digest_ref.len() < MIN_TOKEN_SHA_LEN {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::TokenDigestMalformed(
                    self.packet_id.clone(),
                ),
            );
        }
        if self.phases.is_empty() {
            return Err(SmallModelFreshProductRuntimeAnswerPacketProbeError::EmptyPhase);
        }
        let phase_tags: BTreeSet<&str> = self.phases.iter().map(|phase| phase.tag()).collect();
        for phase in required_fresh_product_runtime_answer_packet_probe_phases() {
            if !phase_tags.contains(phase.tag()) {
                return Err(
                    SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingPhase(phase.tag()),
                );
            }
        }
        if self.answer_packet.id.0 != self.answer_packet_ref {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::PacketIdMismatch(
                    self.packet_id.clone(),
                ),
            );
        }
        ...
        if self.answer_packet.claims.len() < 2 {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::PacketClaimsMissing(
                    self.packet_id.clone(),
                ),
            );
        }
        ...
        {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::PacketClaimNotActive(
                    self.packet_id.clone(),
                ),
            );
        }
        ...
        if self.answer_packet.attention_mode != AttentionMode::Dynamic {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::PacketAttentionModeMismatch(
                    self.packet_id.clone(),
                ),
            );
        }
        ...
        {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::StaticFallbackContradiction(
                    self.packet_id.clone(),
                ),
            );
        }
        if self.answer_packet.ui_label == VrmLabel::Verified {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::PacketUiLabelOverclaim(
                    self.packet_id.clone(),
                ),
            );
        }
        if self.answer_packet.residency_signals.len() != 1 {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::ResidencySignalMissing(
                    self.packet_id.clone(),
                ),
            );
        }
        ...
        {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::ResidencySignalNonNeutral(
                    self.packet_id.clone(),
                ),
            );
        }
        if self.run_event_log.validate_ordinal_density().is_err() {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::RunEventLogNotDense(
                    self.packet_id.clone(),
                ),
            );
        }
        ...
        {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::RunEventLogMissingStop(
                    self.packet_id.clone(),
                ),
            );
        }
        if self.run_event_log.error_count() != 0 {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::RunEventLogHasErrors(
                    self.packet_id.clone(),
                ),
            );
        }
        ...
        if self.run_event_log_root_ref != expected_root {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::RunEventLogRootMismatch(
                    self.packet_id.clone(),
                ),
            );
        }
        let packet_json = serde_json::to_vec(&self.answer_packet).map_err(|_| {
            SmallModelFreshProductRuntimeAnswerPacketProbeError::PacketJsonDigestMismatch(
                self.packet_id.clone(),
            )
        })?;
        ...
        if !log_json.contains(&redacted_marker) {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::RedactedFinalTextMissing(
                    self.packet_id.clone(),
                ),
            );
        }
        ...
        {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::TokenTextRetained(
                    self.packet_id.clone(),
                ),
            );
        }
        ...
        if self.prompt_contains_user_data {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::PromptUserData(
                    self.packet_id.clone(),
                ),
            );
        }
        if self.committed_mutation {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::MutationCommitted(
                    self.packet_id.clone(),
                ),
            );
        }
        if self.route_policy_mutation_attempted {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::RoutePolicyMutation(
                    self.packet_id.clone(),
                ),
            );
        }
        ...
        if self.answer_packet_suppressed {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::AnswerPacketSuppression(
                    self.packet_id.clone(),
                ),
            );
        }
        if self.hidden_route_authority_attempted {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::HiddenRouteAuthority(
                    self.packet_id.clone(),
                ),
            );
        }
        if self.hidden_chain_exposed {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::HiddenChainExposure(
                    self.packet_id.clone(),
                ),
            );
        }
        if self.hidden_cloud_fallback_allowed {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::HiddenCloudFallback(
                    self.packet_id.clone(),
                ),
            );
        }
        if self.subprocess_spawned_in_app_path {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::AppPathSubprocessSpawn(
                    self.packet_id.clone(),
                ),
            );
        }
        if self.autogenous_kernel_attempted {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::AutogenousKernelAttempt(
                    self.packet_id.clone(),
                ),
            );
        }
        if self.seventy_b_probe_attempted {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::SeventyBProbeAttempt(
                    self.packet_id.clone(),
                ),
            );
        }
        ...
        if self.packetization_runtime_bytes_loaded != 0 {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::NewRuntimeBytesLoaded(
                    self.packet_id.clone(),
                ),
            );
        }
        if self.packetization_model_bytes_loaded != 0 {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::NewModelBytesLoaded(
                    self.packet_id.clone(),
                ),
            );
        }
        if self.upstream_runtime_bytes_loaded == 0 {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::UpstreamRuntimeBytesMissing(
                    self.packet_id.clone(),
                ),
            );
        }
        if self.upstream_model_bytes_loaded == 0 {
            return Err(
                SmallModelFreshProductRuntimeAnswerPacketProbeError::UpstreamModelBytesMissing(
                    self.packet_id.clone(),
                ),
            );
        }
...
#[derive(Clone, Debug)]
// UAS: uas:small-model-runtime-harness-fresh-product-runtime-answer-packet-probe:metrics
// Plane: Verification
// Residency: aggregate packetized fresh product-runtime metrics.
pub struct SmallModelFreshProductRuntimeAnswerPacketProbeMetrics {
...
#[derive(Clone, Debug)]
// UAS: uas:small-model-runtime-harness-fresh-product-runtime-answer-packet-probe:witness
// Plane: Controller + Verification
// Residency: complete packetized fresh product-runtime witness.
pub struct SmallModelFreshProductRuntimeAnswerPacketProbeWitness {
    ...
    pub packets: Vec<SmallModelFreshProductRuntimeAnswerPacketPacket>,
    pub surfaces: Vec<SmallModelFreshProductRuntimeAnswerPacketSurface>,
...
impl SmallModelFreshProductRuntimeAnswerPacketProbeWitness {
    #[allow(clippy::too_many_arguments)]
    pub fn new(
        ...
        packets: Vec<SmallModelFreshProductRuntimeAnswerPacketPacket>,
        surfaces: Vec<SmallModelFreshProductRuntimeAnswerPacketSurface>,
        metadata_bytes: u64,
    ...
    pub fn validate(&self) -> Result<(), SmallModelFreshProductRuntimeAnswerPacketProbeError> {
        ...
        if self.product_build != ProductBuild::Pro
            ...
            || self.route_authority != "fresh_product_runtime_packetized_visible_proof_only"
        {
            return Err(SmallModelFreshProductRuntimeAnswerPacketProbeError::ProductStatusMismatch);
        }
        if self.packets.is_empty() {
            return Err(SmallModelFreshProductRuntimeAnswerPacketProbeError::EmptyPacket);
        }
        ...
        for packet in &self.packets {
            ...
            if !packet_ids.insert(packet.packet_id.clone()) {
                return Err(
                    SmallModelFreshProductRuntimeAnswerPacketProbeError::DuplicatePacket(
        ...
        for surface in &self.surfaces {
            if !surface_ids.insert(surface.surface_id.clone()) {
                return Err(
                    SmallModelFreshProductRuntimeAnswerPacketProbeError::DuplicateSurface(
        ...
        if self.l2_green_claimed {
            return Err(SmallModelFreshProductRuntimeAnswerPacketProbeError::L2GreenClaimAttempted);
        }
    ...
    pub fn metrics(&self) -> SmallModelFreshProductRuntimeAnswerPacketProbeMetrics {
    ...
    pub fn address(&self) -> String {
        let mut parts = vec![
            ...
            self.fresh_live_artifact_ref.clone(),
...
pub fn required_fresh_product_runtime_answer_packet_probe_phases(
    ...
    [
        ...
        SmallModelFreshProductRuntimeAnswerPacketPhase::PacketProducerBound,
        SmallModelFreshProductRuntimeAnswerPacketPhase::AnswerPacketSerialized,
        SmallModelFreshProductRuntimeAnswerPacketPhase::ClaimsBound,
        SmallModelFreshProductRuntimeAnswerPacketPhase::AttentionModeChecked,
        SmallModelFreshProductRuntimeAnswerPacketPhase::ResidencySignalBound,
        SmallModelFreshProductRuntimeAnswerPacketPhase::RunEventLogSerialized,
        SmallModelFreshProductRuntimeAnswerPacketPhase::RunEventLogRootBound,
        SmallModelFreshProductRuntimeAnswerPacketPhase::TokenRedactionVerified,
        SmallModelFreshProductRuntimeAnswerPacketPhase::RollbackVerified,
        SmallModelFreshProductRuntimeAnswerPacketPhase::EvidenceReviewPending,
    ]
}

pub fn redacted_fresh_product_runtime_run_event_log(token_digest_ref: &str) -> RunEventLog {
...
fn validate_prefixed(
    ...
    value: &str,
    prefix: &str,
    error: fn(String) -> SmallModelFreshProductRuntimeAnswerPacketProbeError,
) -> Result<(), SmallModelFreshProductRuntimeAnswerPacketProbeError> {
...
fn validate_clean(
    ...
    if value.is_empty() {
        return Err(SmallModelFreshProductRuntimeAnswerPacketProbeError::MissingField(field));
    }
    if value.trim() != value {
        return Err(
...
mod tests {
    ...
    fn phases() -> Vec<SmallModelFreshProductRuntimeAnswerPacketPhase> {
    ...
    fn packet_value(id: &str) -> AnswerPacket {
        AnswerPacket::new(
            ...
            WitnessedStateId::new("witnessed_state:fresh_product_runtime:qwen3_4b"),
    ...
    fn packet(id: &str) -> SmallModelFreshProductRuntimeAnswerPacketPacket {
        ...
        let log = redacted_fresh_product_runtime_run_event_log(token_ref);
        let log_root = format!("run_event_log_root:{}", log.root_hash().to_hex());
        SmallModelFreshProductRuntimeAnswerPacketPacket::new(
            id,
            "artifact:small_model_runtime_harness_fresh_product_runtime_live_probe:result",
            "artifact:small_model_runtime_harness_fresh_product_runtime_live_probe:live_probe:sha256:test",
    ...
    fn surface(id: &str) -> SmallModelFreshProductRuntimeAnswerPacketSurface {
        SmallModelFreshProductRuntimeAnswerPacketSurface::new(
            id,
            format!("surface:{id}"),
            "Epistemos is a local cognitive substrate where every meaningful object has an address, plane, budget, status, and witness; MAS ships the safe floor, Pro contains the gated/research/vault/omega ladder, and no claim promotes without visible proof. small_model_runtime_harness_fresh_product_runtime_answer_packet_probe packetizes the fresh product-runtime witness through AnswerPacket RunEventLog rollback privacy budget without making L2 or L3 green and without live 70B or long-context shard work.",
            vec![
    ...
    fn witness() -> SmallModelFreshProductRuntimeAnswerPacketProbeWitness {
        SmallModelFreshProductRuntimeAnswerPacketProbeWitness::new(
            ...
            vec![packet("answer_packet:qwen3_4b:fresh-product-runtime")],
    ...
    fn duplicate_packet_is_rejected() {
        ...
        assert!(matches!(
            good.validate(),
            Err(SmallModelFreshProductRuntimeAnswerPacketProbeError::DuplicatePacket(_))
        ));
    }

    #[test]
    fn static_fallback_ack_on_dynamic_is_rejected() {
        let mut bad = packet("answer_packet:qwen3_4b:fresh-product-runtime");
    ...
    fn verified_ui_label_is_rejected_for_runtime_packetization() {
        ...
        assert!(matches!(
            bad.validate(),
            Err(SmallModelFreshProductRuntimeAnswerPacketProbeError::PacketUiLabelOverclaim(_))
        ));
    }
    ...
    fn raw_token_text_marker_is_rejected() {
        ...
        assert!(matches!(
            bad.validate(),
            Err(SmallModelFreshProductRuntimeAnswerPacketProbeError::TokenTextRetained(_))
        ));
    }
    ...
    fn run_event_log_missing_stop_is_rejected() {
        ...
        assert!(matches!(
            bad.validate(),
            Err(SmallModelFreshProductRuntimeAnswerPacketProbeError::RunEventLogMissingStop(_))
        ));
    }
    ...
    fn new_runtime_bytes_are_rejected() {
        ...
        assert!(matches!(
            bad.validate(),
            Err(SmallModelFreshProductRuntimeAnswerPacketProbeError::NewRuntimeBytesLoaded(_))
        ));
    }
    ...
    fn hidden_70b_and_long_context_are_rejected() {
        ...
        assert!(matches!(
            bad.validate(),
            Err(SmallModelFreshProductRuntimeAnswerPacketProbeError::SeventyBProbeAttempt(_))
        ));
        let mut bad = packet("answer_packet:qwen3_4b:fresh-product-runtime");
