...
#[async_trait]
impl super::Tool for IMessageContactsHandler {
    fn name(&self) -> &'static str { "communication.imessage_contacts" }
    fn input_schema(&self) -> &'static Value {
        super::v2_catalog::communication_imessage_contacts::input_schema()
    }
