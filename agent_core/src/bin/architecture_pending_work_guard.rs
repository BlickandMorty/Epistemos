...
const SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_LIVE_PROBE_PATH: &str =
    "artifacts/falsifiers/small_model_runtime_harness_fresh_product_runtime_live_probe/result.json";
const SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_ANSWER_PACKET_PROBE_PATH: &str =
...
fn build_report() -> GuardReport {
    ...
    let small_model_runtime_harness_answer_packet_runtime_probe = read_json(Path::new(
        SMALL_MODEL_RUNTIME_HARNESS_ANSWER_PACKET_RUNTIME_PROBE_PATH,
    ));
    let small_model_runtime_harness_answer_packet_runtime_probe_available = artifact_all_axes_true(
        &small_model_runtime_harness_answer_packet_runtime_probe,
        SMALL_MODEL_RUNTIME_HARNESS_ANSWER_PACKET_RUNTIME_PROBE_AXES,
    );
    let small_model_runtime_harness_product_wrv_probe = read_json(Path::new(
        SMALL_MODEL_RUNTIME_HARNESS_PRODUCT_WRV_PROBE_PATH,
    ));
    let small_model_runtime_harness_product_wrv_probe_available = artifact_all_axes_true(
        &small_model_runtime_harness_product_wrv_probe,
        SMALL_MODEL_RUNTIME_HARNESS_PRODUCT_WRV_PROBE_AXES,
    );
    let small_model_runtime_harness_product_answer_packet_live_probe = read_json(Path::new(
        SMALL_MODEL_RUNTIME_HARNESS_PRODUCT_ANSWER_PACKET_LIVE_PROBE_PATH,
    ));
    let small_model_runtime_harness_product_answer_packet_live_probe_available =
    ...
    let small_model_runtime_harness_fresh_product_runtime_safety_lease = read_json(Path::new(
        SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_SAFETY_LEASE_PATH,
    ));
    let small_model_runtime_harness_fresh_product_runtime_safety_lease_available =
        artifact_all_axes_true(
            &small_model_runtime_harness_fresh_product_runtime_safety_lease,
            SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_SAFETY_LEASE_AXES,
        );
    let small_model_runtime_harness_fresh_product_runtime_live_probe = read_json(Path::new(
        SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_LIVE_PROBE_PATH,
    ));
    let small_model_runtime_harness_fresh_product_runtime_live_probe_available =
        artifact_all_axes_true(
            &small_model_runtime_harness_fresh_product_runtime_live_probe,
            SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_LIVE_PROBE_AXES,
        );
    let small_model_runtime_harness_fresh_product_runtime_answer_packet_probe = read_json(
        Path::new(SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_ANSWER_PACKET_PROBE_PATH),
    );
    let small_model_runtime_harness_fresh_product_runtime_answer_packet_probe_available =
        artifact_all_axes_true(
            &small_model_runtime_harness_fresh_product_runtime_answer_packet_probe,
            SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_ANSWER_PACKET_PROBE_AXES,
        );
    let small_model_runtime_harness_fresh_product_runtime_wrv_probe = read_json(Path::new(
        SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_WRV_PROBE_PATH,
    ));
    let small_model_runtime_harness_fresh_product_runtime_wrv_probe_available =
        artifact_all_axes_true(
    ...
    let small_model_runtime_harness_fresh_product_runtime_l3_log_correlation_probe = read_json(
        Path::new(SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_L3_LOG_CORRELATION_PROBE_PATH),
    );
    let small_model_runtime_harness_fresh_product_runtime_l3_log_correlation_probe_available =
        artifact_all_axes_true(
            &small_model_runtime_harness_fresh_product_runtime_l3_log_correlation_probe,
            SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_L3_LOG_CORRELATION_PROBE_AXES,
        );
    let small_model_runtime_harness_fresh_product_runtime_l3_manual_runtime_verification_probe =
        read_json(Path::new(
            SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_L3_MANUAL_RUNTIME_VERIFICATION_PROBE_PATH,
        ));
    let small_model_runtime_harness_fresh_product_runtime_l3_manual_runtime_verification_probe_available =
        artifact_all_axes_true(
    ...
    let small_model_runtime_harness_fresh_product_runtime_l3_release_audit_preflight_probe =
        read_json(Path::new(
            SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_L3_RELEASE_AUDIT_PREFLIGHT_PROBE_PATH,
        ));
    let small_model_runtime_harness_fresh_product_runtime_l3_release_audit_preflight_probe_available =
        artifact_all_axes_true(
    ...
    let small_model_runtime_harness_fresh_product_runtime_l3_release_audit_automated_checks_probe =
        read_json(Path::new(
            SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_L3_RELEASE_AUDIT_AUTOMATED_CHECKS_PROBE_PATH,
        ));
    let small_model_runtime_harness_fresh_product_runtime_l3_release_audit_automated_checks_probe_available =
        artifact_all_axes_true(
    ...
    let small_model_runtime_harness_fresh_product_runtime_l3_release_audit_log_evidence_probe_available =
        artifact_all_axes_true(
    ...
    let required_state_present = capability.is_some()
        ...
        && (heavy_long_context_enabled
            || !small_model_runtime_harness_first_token_runtime_probe_available
            || small_model_runtime_harness_answer_packet_runtime_probe_available)
        && (heavy_long_context_enabled
            || !small_model_runtime_harness_answer_packet_runtime_probe_available
        ...
        && (heavy_long_context_enabled
            || !small_model_runtime_harness_product_route_capability_recheck_available
            || small_model_runtime_harness_fresh_product_runtime_safety_lease_available)
        && (next_existing_work
            != "small_model_runtime_harness_fresh_product_runtime_answer_packet_probe"
            || small_model_runtime_harness_fresh_product_runtime_live_probe_available)
        && (next_existing_work != "small_model_runtime_harness_fresh_product_runtime_wrv_probe"
        ...
        && (next_existing_work
            != "small_model_runtime_harness_fresh_product_runtime_l3_release_audit_log_evidence_probe"
            || small_model_runtime_harness_fresh_product_runtime_l3_release_audit_automated_checks_probe_available)
    ...
    add_bool_axis(
        ...
        &mut thresholds,
        &mut pass_per_axis,
        "small_model_runtime_harness_fresh_product_runtime_l3_release_audit_log_evidence_probe_available",
        small_model_runtime_harness_fresh_product_runtime_l3_release_audit_log_evidence_probe_available,
    );
    add_bool_axis(
        &mut measurements,
    ...
    add_json_measurement(
        ...
        serde_json::json!({
            ...
            "large_model_non_runtime_rungs": {
                ...
                "small_model_runtime_harness_answer_packet_runtime_probe": {
                    "path": SMALL_MODEL_RUNTIME_HARNESS_ANSWER_PACKET_RUNTIME_PROBE_PATH,
                    "available": small_model_runtime_harness_answer_packet_runtime_probe_available
                },
                "small_model_runtime_harness_product_wrv_probe": {
                    "path": SMALL_MODEL_RUNTIME_HARNESS_PRODUCT_WRV_PROBE_PATH,
                    "available": small_model_runtime_harness_product_wrv_probe_available
                },
                "small_model_runtime_harness_product_answer_packet_live_probe": {
                ...
                "small_model_runtime_harness_fresh_product_runtime_safety_lease": {
                    "path": SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_SAFETY_LEASE_PATH,
                    "available": small_model_runtime_harness_fresh_product_runtime_safety_lease_available
                },
                "small_model_runtime_harness_fresh_product_runtime_live_probe": {
                    "path": SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_LIVE_PROBE_PATH,
                    "available": small_model_runtime_harness_fresh_product_runtime_live_probe_available
                },
                "small_model_runtime_harness_fresh_product_runtime_answer_packet_probe": {
                    "path": SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_ANSWER_PACKET_PROBE_PATH,
                    "available": small_model_runtime_harness_fresh_product_runtime_answer_packet_probe_available
                },
                "small_model_runtime_harness_fresh_product_runtime_wrv_probe": {
                ...
                "small_model_runtime_harness_fresh_product_runtime_l3_log_correlation_probe": {
                    "path": SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_L3_LOG_CORRELATION_PROBE_PATH,
                    "available": small_model_runtime_harness_fresh_product_runtime_l3_log_correlation_probe_available
                },
                "small_model_runtime_harness_fresh_product_runtime_l3_manual_runtime_verification_probe": {
                ...
                "small_model_runtime_harness_fresh_product_runtime_l3_release_audit_automated_checks_probe": {
                    "path": SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_L3_RELEASE_AUDIT_AUTOMATED_CHECKS_PROBE_PATH,
                    "available": small_model_runtime_harness_fresh_product_runtime_l3_release_audit_automated_checks_probe_available
                },
                "small_model_runtime_harness_fresh_product_runtime_l3_release_audit_log_evidence_probe": {
                    "path": SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_L3_RELEASE_AUDIT_LOG_EVIDENCE_PROBE_PATH,
                    "available": small_model_runtime_harness_fresh_product_runtime_l3_release_audit_log_evidence_probe_available
                },
                "provider_reference_manifest_dry_run": {
    ...
    {
        anomalies.push(serde_json::json!({
            "kind": "missing_small_model_runtime_harness_answer_packet_runtime_probe",
            "detail": "SmallModelRuntimeHarnessFirstTokenRuntimeProbe is present; the next non-heavy cursor must packetize that retained first-token sidecar into a real AnswerPacket and dense RunEventLog with redaction, rollback, admission, privacy, budget, no new runtime/model bytes, and explicit L2/L3 non-promotion."
        }));
    }
    if small_model_runtime_harness_answer_packet_runtime_probe_available
        && !small_model_runtime_harness_product_wrv_probe_available
        && !heavy_long_context_enabled
    {
        anomalies.push(serde_json::json!({
            "kind": "missing_small_model_runtime_harness_product_wrv_probe",
            "detail": "SmallModelRuntimeHarnessAnswerPacketRuntimeProbe is present as retained L1 packetized runtime evidence. The next cursor must prove product WRV source/test reachability through TriageService, LLMService, NoteChatState, AnswerPacketEmitter, Settings diagnostics, MessageBubble chips, and focused tests without loading model/runtime bytes or promoting L2."
        }));
    }
    if small_model_runtime_harness_product_wrv_probe_available
        && !small_model_runtime_harness_product_answer_packet_live_probe_available
        && !heavy_long_context_enabled
    {
        anomalies.push(serde_json::json!({
    ...
    {
        anomalies.push(serde_json::json!({
            "kind": "small_model_runtime_harness_fresh_product_runtime_l3_manual_runtime_verification_bound",
            "detail": "SmallModelRuntimeHarnessFreshProductRuntimeL3ManualRuntimeVerificationProbe is present as visible manual-review evidence over the fresh Qwen3-4B sidecar, AnswerPacket, RunEventLog, Living Index, lattice HTML, and red capability ledger. It opens zero new bytes and queues capability closeout/recheck; L2 remains vault_research_route_with_packetized_mitigation."
        }));
    } else if small_model_runtime_harness_fresh_product_runtime_safety_lease_available
        && small_model_runtime_harness_fresh_product_runtime_live_probe_available
        && small_model_runtime_harness_fresh_product_runtime_answer_packet_probe_available
    ...
    {
        anomalies.push(serde_json::json!({
            "kind": "small_model_runtime_harness_fresh_product_runtime_l3_log_correlation_bound",
            "detail": "SmallModelRuntimeHarnessFreshProductRuntimeL3LogCorrelationProbe is present as L1/L3-source proof: the fresh Qwen3-4B live sidecar, AnswerPacket JSON, RunEventLog JSON, source WRV, and capability blocker ledger correlate on token digest, stop reason, prompt privacy, and visible app surfaces with zero new runtime/model bytes. The next cursor is manual product-runtime verification; L2 remains vault_research_route_with_packetized_mitigation and no MAS/70B/128K/autogenous-kernel claim promotes."
        }));
    } else if small_model_runtime_harness_fresh_product_runtime_safety_lease_available
        && small_model_runtime_harness_fresh_product_runtime_live_probe_available
        && small_model_runtime_harness_fresh_product_runtime_answer_packet_probe_available
    ...
    {
        anomalies.push(serde_json::json!({
            "kind": "small_model_runtime_harness_fresh_product_runtime_answer_packet_probe_l1_only",
            "detail": "SmallModelRuntimeHarnessFreshProductRuntimeAnswerPacketProbe is present as an L1-only packetization witness: the fresh Qwen3-4B product-runtime sidecar is bound into a real AnswerPacket and dense RunEventLog with rollback, admission, privacy, budget, and no new model/runtime bytes. L2 remains vault_research_route_with_packetized_mitigation and L3 WRV remains unpromoted while the next cursor moves to fresh product-runtime WRV."
        }));
    } else if small_model_runtime_harness_fresh_product_runtime_safety_lease_available
        && small_model_runtime_harness_fresh_product_runtime_live_probe_available
        && !heavy_long_context_enabled
    {
        anomalies.push(serde_json::json!({
            "kind": "small_model_runtime_harness_fresh_product_runtime_live_probe_l1_only",
            "detail": "SmallModelRuntimeHarnessFreshProductRuntimeLiveProbe is present as an L1-only fresh product-path sidecar: exactly one redacted Qwen3-4B token under byte/timing budgets. It preserves L2 vault_research_route_with_packetized_mitigation and L3 unpromoted product runtime while queuing fresh product AnswerPacket packaging; no MAS/70B/128K/autogenous-kernel claim promotes."
        }));
    } else if small_model_runtime_harness_fresh_product_runtime_safety_lease_available
        && !heavy_long_context_enabled
    {
        anomalies.push(serde_json::json!({
            ...
            "detail": "SmallModelRuntimeHarnessFreshProductRuntimeSafetyLease is present as an L1 metadata-only lease. It preserves L2 vault_research_route_with_packetized_mitigation and L3 unverified product runtime while queuing only a separate fresh product runtime live probe; no MAS/70B/128K/autogenous-kernel claim promotes."
        }));
    } else if small_model_runtime_harness_product_answer_packet_live_probe_available
        && !heavy_long_context_enabled
    {
        anomalies.push(serde_json::json!({
            ...
            "detail": "SmallModelRuntimeHarnessProductAnswerPacketLiveProbe is present as retained-live product handoff evidence. It binds bounded Qwen3-4B runtime bytes to product AnswerPacket/RunEventLog surfaces without fresh model bytes, while L2 remains vault_research_route_with_packetized_mitigation and no MAS/70B/128K claim promotes."
        }));
    } else if small_model_runtime_harness_first_token_runtime_probe_available
        && !heavy_long_context_enabled
    {
        anomalies.push(serde_json::json!({
