...
const CANONICAL_FALSIFIER_IDS: &[&str] = &[
    ...
    "F-ReleaseAuditDistributionFocusedEvidence",
    "F-ReleaseAuditDistributionComplianceReview",
    "F-ReleaseAuditZeroFailPassLedger",
    ...
    "F-GemmaLocalArtifactAcquisitionPlan",
