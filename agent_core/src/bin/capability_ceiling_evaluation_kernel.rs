...
const SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_LIVE_PROBE_NEXT: &str =
    "small_model_runtime_harness_fresh_product_runtime_answer_packet_probe";
const SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_ANSWER_PACKET_PROBE_NEXT: &str =
...
const SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_L3_MANUAL_RUNTIME_VERIFICATION_PROBE_NEXT: &str =
    "small_model_runtime_harness_fresh_product_runtime_l3_capability_closeout_probe";
const SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_L3_CAPABILITY_CLOSEOUT_PROBE_NEXT: &str =
    "small_model_runtime_harness_fresh_product_runtime_l3_release_audit_preflight_probe";
const SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_L3_RELEASE_AUDIT_PREFLIGHT_PROBE_NEXT:
    &str = "small_model_runtime_harness_fresh_product_runtime_l3_release_audit_zero_fail_probe";
const SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_L3_RELEASE_AUDIT_ZERO_FAIL_PROBE_NEXT:
    &str =
...
fn build_report() -> KernelReport {
    ...
    let small_model_runtime_harness_fresh_product_runtime_live_probe =
        GateArtifact::read(SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_LIVE_PROBE_PATH);
    let small_model_runtime_harness_fresh_product_runtime_answer_packet_probe = GateArtifact::read(
        SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_ANSWER_PACKET_PROBE_PATH,
    );
    ...
    let small_model_runtime_harness_product_route_capability_recheck_pass =
    ...
    let small_model_runtime_harness_fresh_product_runtime_live_probe_pass =
        small_model_runtime_harness_fresh_product_runtime_live_probe.overall_pass
            && small_model_runtime_harness_fresh_product_runtime_live_probe
                .all_axes_true(SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_LIVE_PROBE_AXES);
    let small_model_runtime_harness_fresh_product_runtime_answer_packet_probe_pass =
        small_model_runtime_harness_fresh_product_runtime_answer_packet_probe.overall_pass
            && small_model_runtime_harness_fresh_product_runtime_answer_packet_probe.all_axes_true(
                SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_ANSWER_PACKET_PROBE_AXES,
            );
    let small_model_runtime_harness_fresh_product_runtime_wrv_probe_pass =
    ...
    let small_model_runtime_harness_fresh_product_runtime_l3_manual_runtime_verification_probe_pass =
        small_model_runtime_harness_fresh_product_runtime_l3_manual_runtime_verification_probe
            .overall_pass
            && small_model_runtime_harness_fresh_product_runtime_l3_manual_runtime_verification_probe
                .all_axes_true(
    ...
    let small_model_runtime_harness_fresh_product_runtime_l3_capability_closeout_probe_pass =
        small_model_runtime_harness_fresh_product_runtime_l3_capability_closeout_probe.overall_pass
            && small_model_runtime_harness_fresh_product_runtime_l3_capability_closeout_probe
                .all_axes_true(
                SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_L3_CAPABILITY_CLOSEOUT_PROBE_AXES,
            );
    let small_model_runtime_harness_fresh_product_runtime_l3_release_audit_preflight_probe_pass =
        small_model_runtime_harness_fresh_product_runtime_l3_release_audit_preflight_probe
            .overall_pass
            && small_model_runtime_harness_fresh_product_runtime_l3_release_audit_preflight_probe
                .all_axes_true(
    ...
    let small_model_runtime_harness_fresh_product_runtime_l3_release_audit_zero_fail_probe_pass =
        small_model_runtime_harness_fresh_product_runtime_l3_release_audit_zero_fail_probe
            .overall_pass
            && small_model_runtime_harness_fresh_product_runtime_l3_release_audit_zero_fail_probe
                .all_axes_true(
    ...
    let small_model_runtime_harness_fresh_product_runtime_l3_release_audit_automated_checks_probe_pass =
        small_model_runtime_harness_fresh_product_runtime_l3_release_audit_automated_checks_probe
            .overall_pass
            && small_model_runtime_harness_fresh_product_runtime_l3_release_audit_automated_checks_probe
                .all_axes_true(
        ...
        && base_next_bottleneck == SMALL_MODEL_RUNTIME_HARNESS_ANSWER_PACKET_RUNTIME_PROBE_NEXT
    {
        ...
        && base_next_bottleneck == SMALL_MODEL_RUNTIME_HARNESS_ANSWER_PACKET_RUNTIME_PROBE_NEXT
    {
        SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_L3_RELEASE_AUDIT_ZERO_FAIL_PROBE_NEXT
            .to_string()
    } else if !seventy_b_route_pass
        && !heavy_long_context_enabled
        && small_model_runtime_harness_product_route_capability_recheck_pass
        ...
        && base_next_bottleneck == SMALL_MODEL_RUNTIME_HARNESS_ANSWER_PACKET_RUNTIME_PROBE_NEXT
    {
        SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_L3_RELEASE_AUDIT_PREFLIGHT_PROBE_NEXT
            .to_string()
    } else if !seventy_b_route_pass
        && !heavy_long_context_enabled
        && small_model_runtime_harness_product_route_capability_recheck_pass
        ...
        && base_next_bottleneck == SMALL_MODEL_RUNTIME_HARNESS_ANSWER_PACKET_RUNTIME_PROBE_NEXT
    {
        SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_L3_CAPABILITY_CLOSEOUT_PROBE_NEXT
            .to_string()
    } else if !seventy_b_route_pass
        && !heavy_long_context_enabled
        && small_model_runtime_harness_product_route_capability_recheck_pass
        ...
        && base_next_bottleneck == SMALL_MODEL_RUNTIME_HARNESS_ANSWER_PACKET_RUNTIME_PROBE_NEXT
    {
        SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_L3_MANUAL_RUNTIME_VERIFICATION_PROBE_NEXT
            .to_string()
    } else if !seventy_b_route_pass
        && !heavy_long_context_enabled
        && small_model_runtime_harness_product_route_capability_recheck_pass
        ...
        && base_next_bottleneck == SMALL_MODEL_RUNTIME_HARNESS_ANSWER_PACKET_RUNTIME_PROBE_NEXT
    {
        ...
        && base_next_bottleneck == SMALL_MODEL_RUNTIME_HARNESS_ANSWER_PACKET_RUNTIME_PROBE_NEXT
    {
        SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_WRV_PROBE_NEXT.to_string()
    } else if !seventy_b_route_pass
        && !heavy_long_context_enabled
        && small_model_runtime_harness_product_route_capability_recheck_pass
        && small_model_runtime_harness_fresh_product_runtime_safety_lease_pass
        ...
        && base_next_bottleneck == SMALL_MODEL_RUNTIME_HARNESS_ANSWER_PACKET_RUNTIME_PROBE_NEXT
    {
        SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_ANSWER_PACKET_PROBE_NEXT.to_string()
    } else if !seventy_b_route_pass
        && !heavy_long_context_enabled
        && small_model_runtime_harness_product_route_capability_recheck_pass
        && small_model_runtime_harness_fresh_product_runtime_safety_lease_pass
        ...
        && base_next_bottleneck == SMALL_MODEL_RUNTIME_HARNESS_ANSWER_PACKET_RUNTIME_PROBE_NEXT
    {
        SMALL_MODEL_RUNTIME_HARNESS_FRESH_PRODUCT_RUNTIME_LIVE_PROBE_NEXT.to_string()
    } else if !seventy_b_route_pass
        && !heavy_long_context_enabled
        && small_model_runtime_harness_product_route_capability_recheck_pass
        && small_model_runtime_harness_fresh_product_runtime_safety_lease_pass
        && base_next_bottleneck == SMALL_MODEL_RUNTIME_HARNESS_ANSWER_PACKET_RUNTIME_PROBE_NEXT
    {
        ...
        && base_next_bottleneck == SMALL_MODEL_RUNTIME_HARNESS_ANSWER_PACKET_RUNTIME_PROBE_NEXT
    {
        SMALL_MODEL_RUNTIME_HARNESS_PRODUCT_ROUTE_CAPABILITY_RECHECK_NEXT.to_string()
    } else if !seventy_b_route_pass
        && !heavy_long_context_enabled
        && small_model_runtime_harness_answer_packet_runtime_probe_pass
    ...
    {
        anomalies.push(serde_json::json!({
            "kind": "small_model_harness_fresh_product_runtime_l3_release_audit_zero_fail_gate_red",
            "detail": "Zero-fail release audit gate is present: automated checks, log evidence, manual runtime review, distribution/compliance review, and three uninterrupted passes remain blockers; no ship call, L2 green claim, or product capability promotion is authorized."
        }));
    } else if !seventy_b_route_pass
        && !heavy_long_context_enabled
        && small_model_runtime_harness_product_route_capability_recheck_pass
    ...
    {
        anomalies.push(serde_json::json!({
            "kind": "small_model_harness_fresh_product_runtime_l3_release_audit_preflight_red",
            "detail": "Release-audit preflight is present: the log-first/zero-fail skill requirement is queued, no fresh model/runtime bytes open, no ship call is authorized, and L2 remains vault_research_route_with_packetized_mitigation until zero-fail release audit and product-route blockers pass."
        }));
    } else if !seventy_b_route_pass
        && !heavy_long_context_enabled
        && small_model_runtime_harness_product_route_capability_recheck_pass
    ...
    {
        anomalies.push(serde_json::json!({
            "kind": "small_model_harness_fresh_product_runtime_l3_capability_closeout_red",
            "detail": "Fresh product-runtime L3 capability closeout is present: the Qwen3-4B proof segment is closed as visible L1/L3 evidence, no new model/runtime bytes open, and L2 remains vault_research_route_with_packetized_mitigation until release-audit preflight and broader product-route blockers pass."
        }));
    } else if !seventy_b_route_pass
        && !heavy_long_context_enabled
        && small_model_runtime_harness_product_route_capability_recheck_pass
    ...
    {
        anomalies.push(serde_json::json!({
            "kind": "small_model_harness_fresh_product_runtime_l3_manual_runtime_verification_bound",
            "detail": "Fresh product-runtime L3 manual verification is present: Living Index, lattice HTML, AnswerPacket, RunEventLog, and the red capability ledger bind the fresh Qwen3-4B proof to visible operator-review evidence. No new model/runtime bytes open, and L2 remains vault_research_route_with_packetized_mitigation until capability closeout/recheck and broader route blockers pass."
        }));
    } else if !seventy_b_route_pass
        && !heavy_long_context_enabled
        && small_model_runtime_harness_product_route_capability_recheck_pass
        ...
        && small_model_runtime_harness_fresh_product_runtime_wrv_probe_pass
    {
        anomalies.push(serde_json::json!({
            ...
            "detail": "Fresh product-runtime WRV is present as L1/L3-source evidence: fresh Qwen3-4B AnswerPacket/RunEventLog sidecars are bound to app source, Settings diagnostics, message chip visibility, System G replay, and focused tests without opening new runtime/model bytes. L2 remains vault_research_route_with_packetized_mitigation until the fresh capability recheck enumerates remaining blockers; no 70B/128K/MAS live-agent claim is implied."
        }));
    } else if !seventy_b_route_pass
        && !heavy_long_context_enabled
        && small_model_runtime_harness_answer_packet_runtime_probe_pass
        ...
        && small_model_runtime_harness_fresh_product_runtime_live_probe_pass
    {
        anomalies.push(serde_json::json!({
            ...
            "detail": "Fresh product runtime live probe is present as L1-only sidecar evidence: exactly one redacted Qwen3-4B token was observed under the safety lease with bounded model/runtime bytes. L2 remains vault_research_route_with_packetized_mitigation and L3 remains unpromoted until fresh product AnswerPacket packaging/WRV is proven; no 70B/128K/MAS live-agent claim is implied."
        }));
    } else if !seventy_b_route_pass
        && !heavy_long_context_enabled
        && small_model_runtime_harness_fresh_product_runtime_safety_lease_pass
