...
pub use closure_builders::{
    ...
    closure_gelu_sigmoid_approx, closure_logit, closure_sigmoid_scaled, closure_silu,
    closure_smooth_max, closure_smooth_min, closure_softmax_temperature_pinned,
    closure_softmax_temperature_slot,
