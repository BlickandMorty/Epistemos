...
pub use closure_builders::{
    ...
    closure_categorical_softmax_slot, closure_exp, closure_gaussian_dual_map,
    closure_gaussian_log_partition, closure_kl_bernoulli, closure_kl_categorical,
    closure_kl_gaussian, closure_ln, closure_lse, closure_mul, closure_neg_exp,
    closure_neg_slot, closure_sigmoid, closure_softplus, closure_tanh, closure_zero,
};
