...
pub use closure_builders::{
    ...
    closure_kl_geometric, closure_kl_poisson, closure_ln,
    ...
    closure_complementary_sigmoid, closure_sigmoid, closure_sigmoid_of,
    ...
    closure_log_cosh, closure_log_sigmoid, closure_log_sigmoid_of,
