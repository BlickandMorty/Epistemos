...
pub fn lean_certificate(p: &PositiveEmlExpr) -> String {
    ...
    format!(
        "-- Generated by EML-IR certificate.rs (T5 Phase B1 iter-13; Lean-first iter-607)\n\
         ...
         -- Generated branch/eval theorem bodies remain per-tree proof obligations.\n\
...
mod tests {
    ...
    fn certificate_header_tracks_schema_build_and_generated_obligations() {
        ...
        assert!(c.contains("Generated branch/eval theorem bodies remain per-tree proof obligations"));
    }
