...
pub fn lean_certificate(expr: &TropicalExpr) -> String {
    ...
    format!(
        "-- Generated by Tropical-IR certificate.rs (T5 Phase B2 iter-22; Lean-first iter-604)\n\
         ...
         \x20   rfl\n\
         \n\
         theorem tropical_certificate_semiring_source_row_{suffix} :\n\
         ...
         \x20   rfl\n\
         \n\
         theorem tropical_certificate_source_rows_match_{suffix} :\n\
         \x20   tropical_certificate_{suffix}.sourceRow =\n\
         \x20     tropical_certificate_{suffix}.semiringLaws.sourceRow := by\n\
         \x20 exact Epistemos.Tropical.CertificateTarget.sourceRowsMatch\n\
         \x20   tropical_certificate_{suffix}\n\
         \x20   rfl\n\
         \n\
...
mod tests {
    ...
    fn certificate_projects_target_semiring_obligation() {
        ...
        assert!(c.contains("Epistemos.Tropical.CertificateTarget.sourceRowsMatch"));
        ...
        assert!(c.contains("theorem tropical_certificate_semiring_source_row_"));
        assert!(c.contains("Epistemos.Tropical.CertificateTarget.semiringSourceRowMatches"));
    }
