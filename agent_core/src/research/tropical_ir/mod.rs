...
pub use evaluator::{
    ...
    min_plus_matrix_multiply, min_plus_matrix_vector, min_plus_vector_min,
    min_plus_zero, tropical_argmax_idx, tropical_argmin_idx, tropical_convolution,
    tropical_diagonal_matrix, tropical_distance_matrix, tropical_matrix_diagonal,
    ...
    tropical_matrix_negate, tropical_matrix_scalar_add, tropical_matrix_trace,
    tropical_matrix_transpose, tropical_matrix_vector,
    tropical_vector_max,
    tropical_norm_max,
