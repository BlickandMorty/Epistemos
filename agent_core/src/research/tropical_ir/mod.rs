...
pub use certificate::{
    ...
    lean_expr_term as tropical_lean_expr_term, lean_term as tropical_lean_term,
};
pub use compile::{
    compile_max_pool, compile_min_pool, compile_real_relu_layer, compile_relu_layer,
    evaluate_max_pool_directly, evaluate_min_pool_directly, evaluate_real_relu_layer_directly,
...
pub use evaluator::{
    ...
    min_plus_matrix_min_pointwise, min_plus_matrix_multiply, min_plus_matrix_row_min,
    min_plus_matrix_vector, min_plus_pairwise_min, min_plus_vector_argmin_value,
    min_plus_vector_min, min_plus_vector_scalar_min, min_plus_zero, tropical_argmax_idx,
    tropical_argmin_idx, tropical_chebyshev_distance, tropical_constant_matrix,
    tropical_convolution, tropical_diagonal_matrix, tropical_distance_matrix,
    tropical_eigenvalue_estimate, tropical_identity_matrix, tropical_identity_matrix_scaled,
    tropical_inner_product, tropical_l1_distance, tropical_log_softmax, tropical_log_softmin,
    tropical_matrix_col_max, tropical_matrix_diagonal, tropical_matrix_kleene_partial,
    tropical_matrix_max_fold, tropical_matrix_max_pointwise, tropical_matrix_multiply,
    tropical_matrix_negate, tropical_matrix_power, tropical_matrix_row_max,
    tropical_matrix_scalar_add, tropical_matrix_trace, tropical_matrix_transpose,
    tropical_matrix_vector, tropical_min_polynomial, tropical_min_polynomial_argmin_at,
    tropical_min_polynomial_argmin_value_at, tropical_norm_max, tropical_norm_min, tropical_one,
    tropical_outer_sum, tropical_pairwise_max, tropical_polynomial, tropical_polynomial_argmax_at,
    tropical_polynomial_argmax_value_at, tropical_smooth_amplitude,
    tropical_smooth_chebyshev_distance, tropical_smooth_inner_product, tropical_smooth_max,
    tropical_smooth_min, tropical_smooth_min_polynomial, tropical_smooth_polynomial,
    tropical_softmax, tropical_softmax_cross_entropy, tropical_softmax_entropy,
    tropical_softmax_kl_divergence, tropical_softmin, tropical_softmin_entropy,
    tropical_vector_amplitude, tropical_vector_argmax_value, tropical_vector_argmin_argmax_indices,
    tropical_vector_max, tropical_vector_min_max_pair, tropical_vector_negate,
    tropical_vector_pairwise_add, tropical_vector_recenter, tropical_vector_scalar_add,
    tropical_vector_scalar_max, tropical_zero, tropical_zero_matrix, TropicalEvalError,
};
