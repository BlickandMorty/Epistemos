...
pub use evaluator::{
    ...
    tropical_vector_argmax_value, tropical_vector_max,
    tropical_vector_min_max_pair,
    tropical_vector_negate, tropical_vector_pairwise_add,
    tropical_vector_scalar_add, tropical_vector_scalar_max,
    tropical_norm_max, tropical_pairwise_max,
    tropical_smooth_max, tropical_smooth_min, tropical_softmax,
