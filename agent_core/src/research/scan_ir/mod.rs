...
pub use evaluator::{
    ...
    running_count_consecutive_ties, running_count_strict_decrease,
    running_count_strict_increase,
    running_sign_changes,
    running_ema, running_first_difference,
    running_geometric_mean, running_harmonic_mean, running_l1_norm,
    running_cumulative_log_returns,
    ...
    running_range, running_squared_differences, running_squared_increments,
