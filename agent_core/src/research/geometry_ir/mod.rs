...
pub use evaluator::{
    ...
    multivector_weakest_grade, multivector_smooth_weakest_grade,
    multivector_weakest_grade_value_pair,
    multivector_distance, multivector_distance_l1,
    multivector_distance_squared, multivector_dual,
    ...
    multivector_grade_softmin,
    multivector_is_approximately_pure_grade,
    multivector_is_approximately_zero,
    multivector_l1_norm, multivector_linf_norm, multivector_smooth_l_inf_norm,
...
pub use rotor::{
    ...
    rotor_distance, rotor_from_angle_and_bivector, rotor_power, rotor_slerp,
