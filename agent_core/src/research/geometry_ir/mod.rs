...
pub use evaluator::{
    ...
    project_onto_bivector_plane, reflect_vector, reject_from_bivector_plane,
    scalar_triple_product, vector_cross_product, vector_projection,
    vector_rejection,
};
...
pub use rotor::{
    ...
    rotor_identity, rotor_inverse, rotor_to_angle_and_bivector,
};
