...
pub use evaluator::{
    ...
    apply_layer_softmax, apply_layer_softmax_cross_entropy,
    apply_layer_softmax_entropy,
    ...
    apply_layer_cosine_similarity, apply_layer_dot_product,
    apply_layer_pairwise_l1_distance, apply_layer_pairwise_l2_distance,
    apply_layer_pairwise_l2_distance_squared,
    apply_layer_pairwise_l_inf_distance,
    apply_layer_sum,
