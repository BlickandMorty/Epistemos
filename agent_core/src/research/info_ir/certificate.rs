...
/// Emit a Lean 4 certificate for an [`InfoExpr`]. Carries schema-
/// shaped Bregman-positivity, Bregman-non-degeneracy, and mirror-
/// descent equivalence proof obligations.
pub fn lean_certificate(expr: &InfoExpr) -> String {
    ...
    format!(
        "-- Generated by Info-IR certificate.rs (T5 Phase B4 iter-34; Lean-first iter-601)\n\
