...
pub use evaluator::{
    ...
    binary_chi_squared_divergence, binary_entropy, binary_hellinger_distance,
    binary_jeffreys_divergence, binary_jensen_shannon_distance, binary_jensen_shannon_divergence,
    binary_kl_divergence, binary_total_variation_distance, categorical_entropy_from_probs,
    chi_squared_divergence, chi_squared_from_probs, collision_entropy, conditional_entropy,
    cross_entropy, cross_entropy_from_probs, dual_map, effective_sample_size_from_weights, entropy,
    entropy_diff, entropy_ratio, evaluate_dual_map, evaluate_scalar,
    exponential_jeffreys_divergence, exponential_log_pdf, exponential_pdf, fano_inequality_rhs,
    fisher_information, fisher_rao_distance, gaussian_bhattacharyya_distance,
    gaussian_chi_squared_same_variance, gaussian_hellinger_distance,
    gaussian_hellinger_squared_same_variance, gaussian_jeffreys_divergence, gaussian_kl_full,
    gaussian_kl_same_variance, gaussian_log_pdf, gaussian_pdf, gini_impurity, hellinger_distance,
    hellinger_squared_from_probs, hill_number_from_probs, is_valid_joint_distribution,
    is_valid_probability_vector, joint_entropy, js_distance, js_divergence, js_from_probs,
    kl_divergence, kl_exponential, kl_from_probs, kl_geometric, kl_poisson, kl_to_uniform,
    kl_uniform_general, laplace_kl_same_scale, laplace_log_pdf, laplace_pdf, log_partition,
    mean_to_natural, min_entropy, mode_index, mode_probability, mutual_information,
    mutual_information_binary_2x2, normalized_entropy, pareto_jeffreys_same_x_min,
    pareto_kl_same_x_min, pareto_log_pdf, pareto_pdf, perplexity, pinsker_kl_lower_bound,
    poisson_jeffreys_divergence, renyi_divergence_from_probs, renyi_entropy_from_probs,
    symmetric_kl, total_variation_distance, total_variation_from_probs, tsallis_entropy_from_probs,
    uniform_entropy, InfoEvalError,
};
