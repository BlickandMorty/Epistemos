...
pub use evaluator::{
    ...
    binary_chi_squared_divergence,
    binary_entropy, binary_hellinger_distance,
    binary_jeffreys_divergence, binary_jensen_shannon_distance,
    binary_jensen_shannon_divergence,
    ...
    exponential_jeffreys_divergence,
    exponential_log_pdf, exponential_pdf,
    kl_exponential, kl_from_probs, kl_geometric, kl_poisson, kl_to_uniform,
    ...
    gaussian_bhattacharyya_distance, gaussian_hellinger_distance,
