...
pub fn adversarial_query_fixture_token_smuggling_input_count() -> usize {
...
pub fn adversarial_query_fixture_token_lookups_reject_whitespace_input() -> bool {
    adversarial_query_fixture_for_kind_token("   ").is_none()
        && adversarial_query_fixture_for_expected_outcome_token("   ").is_none()
}

pub fn adversarial_query_fixture_token_lookups_reject_invisible_input() -> bool {
    adversarial_query_fixture_for_kind_token("\u{200b}").is_none()
        && adversarial_query_fixture_for_expected_outcome_token("\u{200b}").is_none()
}

pub fn adversarial_query_fixture_token_lookups_reject_control_input() -> bool {
    adversarial_query_fixture_for_kind_token("\u{0000}").is_none()
        && adversarial_query_fixture_for_expected_outcome_token("\u{0000}").is_none()
}

pub fn adversarial_query_fixture_token_lookups_reject_bidi_input() -> bool {
    adversarial_query_fixture_for_kind_token("\u{202e}").is_none()
...
pub fn adversarial_query_fixture_token_smuggling_cases_reject_through_token_lookups() -> bool {
    adversarial_query_fixture_token_smuggling_cases()
        .iter()
        .all(|(_label, input)| {
            adversarial_query_fixture_for_kind_token(input).is_none()
