...
pub use attachments::{
    read_attached_resource, write_attached_resource, AttachedResource, AttachmentMode, Capability,
};
...
pub use service::{
    ...
    write_note_adapter, DeleteMode, ResourceContent, ResourceError, ResourceHit, ResourceKind,
    ResourceSearchScope, ResourceService, VaultResourceService, WriteResult,
};
